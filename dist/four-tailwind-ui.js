import { defineComponent as V, computed as y, openBlock as l, createElementBlock as a, normalizeClass as h, createTextVNode as D, toDisplayString as g, createCommentVNode as f, createElementVNode as n, useSlots as d1, renderSlot as M, ref as z, watch as c1, Fragment as j, renderList as E, onMounted as l1, onBeforeUnmount as W1, withModifiers as I1, createVNode as R, Transition as r1, withCtx as S, createBlock as I, resolveDynamicComponent as P, resolveComponent as U1, h as A, readonly as K1, Teleport as z1, TransitionGroup as J1, unref as $, onUnmounted as p1, inject as D1, provide as T1, normalizeProps as m1, guardReactiveProps as C1, createSlots as X1, normalizeStyle as U, withDirectives as Q1, vModelText as Y1, withKeys as ee } from "vue";
import { useRoute as te } from "vue-router";
const re = ["for"], oe = {
  key: 0,
  class: "text-error-500"
}, le = { class: "relative" }, ne = ["id", "type", "value", "placeholder", "required", "disabled"], ae = {
  key: 0,
    ...
    return (d, c) => (l(), a("div", null, [
      ...
      n("div", le, [
        n("input", {
          ...
          type: e.type,
          value: e.modelValue,
          onInput: c[0] || (c[0] = (u) => d.$emit("update:modelValue", u.target.value)),
          ...
          class: h([
            ...
            s.value,
            i.value,
            { "pr-10": e.showStateIcon && (e.error || e.success) },
            { "disabled:border-gray-100 disabled:bg-gray-50 disabled:text-gray-400 dark:disabled:border-gray-800 dark:disabled:bg-white/[0.03] dark:disabled:text-gray-500": e.disabled }
          ])
        }, null, 42, ne),
        e.showStateIcon && e.error ? (l(), a("span", ae, [...c[1] || (c[1] = [
          n("svg", {
            width: "16",
            height: "16",
            viewBox: "0 0 16 16",
        ...
        e.showStateIcon && e.success && !e.error ? (l(), a("span", se, [...c[2] || (c[2] = [
          n("svg", {
            width: "16",
            height: "16",
            viewBox: "0 0 16 16",
      ...
      e.error ? (l(), a("p", ie, g(e.error), 1)) : e.success ? (l(), a("p", de, g(e.success), 1)) : e.hint ? (l(), a("p", ce, g(e.hint), 1)) : f("", !0)
    ]));
  }
}), ue = ["for"], ge = {
  key: 0,
...
}, he = ["id", "type", "value", "placeholder", "required", "disabled"], me = {
  key: 1,
  ...
  emits: ["update:modelValue"],
  setup(e) {
    const t = e, o = d1(), r = y(() => `input-group-${Math.random().toString(36).substr(2, 9)}`), s = y(() => {
      const i = !!t.prefix || !!o.prefix, d = !!t.suffix || !!o.suffix;
      return i && d ? "rounded-none" : i ? "rounded-l-none rounded-r-lg" : d ? "rounded-l-lg rounded-r-none" : "rounded-lg";
    });
    return (i, d) => (l(), a("div", null, [
      e.label ? (l(), a("label", {
        ...
        D(g(e.label) + " ", 1),
        e.required ? (l(), a("span", ge, "*")) : f("", !0)
      ], 10, ue)) : f("", !0),
      n("div", fe, [
        i.$slots.prefix || e.prefix ? (l(), a("span", be, [
          M(i.$slots, "prefix", {}, () => [
            D(g(e.prefix), 1)
          ])
        ])) : f("", !0),
        n("input", {
          ...
          type: e.type,
          value: e.modelValue,
          onInput: d[0] || (d[0] = (c) => i.$emit("update:modelValue", c.target.value)),
          placeholder: e.placeholder,
          required: e.required,
          disabled: e.disabled,
          class: h([
        ...
        i.$slots.suffix || e.suffix ? (l(), a("span", me, [
          M(i.$slots, "suffix", {}, () => [
            D(g(e.suffix), 1)
          ])
        ])) : f("", !0)
      ]),
      e.error ? (l(), a("p", Ce, g(e.error), 1)) : f("", !0)
    ]));
  }
}), xe = ["for"], ve = {
  key: 0,
  ...
  setup(e, { emit: t }) {
    const o = e, r = t, s = y(() => `email-${Math.random().toString(36).substr(2, 9)}`), i = z(!1), d = z(""), c = /^[^\s@]+@[^\s@]+\.[^\s@]+$/, u = y(() => o.error ? o.error : i.value && d.value ? d.value : "");
    function b(x) {
      var p, k;
      return !x && o.required ? (d.value = ((p = o.errorMessages) == null ? void 0 : p.required) || "Email is required", !1) : x && !c.test(x) ? (d.value = ((k = o.errorMessages) == null ? void 0 : k.invalid) || "Please enter a valid email address", !1) : (d.value = "", !0);
    }
    function m(x) {
      const p = x.target.value;
      r("update:modelValue", p), i.value && c.test(p) && (d.value = "", r("validation", !0));
    }
    function C() {
      i.value = !0;
      const x = b(o.modelValue);
      r("validation", x);
    }
    return c1(() => o.modelValue, (x) => {
      if (i.value) {
        const p = b(x);
        r("validation", p);
      }
      ...
      e.label ? (l(), a("label", {
        ...
        D(g(e.label) + " ", 1),
        e.required ? (l(), a("span", ve, "*")) : f("", !0)
      ], 10, xe)) : f("", !0),
      n("div", pe, [
        p[0] || (p[0] = n("span", { class: "absolute left-0 top-1/2 -translate-y-1/2 border-r border-gray-200 px-3.5 py-3 text-gray-500 dark:border-gray-800 dark:text-gray-400" }, [
          n("svg", {
            width: "20",
            height: "20",
            viewBox: "0 0 20 20",
        ...
        n("input", {
          ...
          required: e.required,
          disabled: e.disabled,
          class: h(["h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 pl-[62px] text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800 disabled:border-gray-100 disabled:bg-gray-50 disabled:text-gray-400 dark:disabled:border-gray-800 dark:disabled:bg-white/[0.03] dark:disabled:text-gray-500", [
            u.value ? "border-error-300 focus:border-error-300 focus:ring-error-500/10 dark:border-error-700 dark:focus:border-error-800" : ""
          ]])
        }, null, 42, ye)
      ]),
      u.value ? (l(), a("p", we, g(u.value), 1)) : f("", !0)
    ]));
  }
}), ke = ["for"], $e = {
  key: 0,
  class: "text-error-500"
}, Ve = { class: "relative z-20 bg-transparent" }, Me = ["id", "value", "required", "disabled"], Le = {
  key: 0,
  value: "",
  disabled: ""
}, He = ["value"], _e = {
  ...
  emits: ["update:modelValue"],
  setup(e) {
    const t = y(() => `select-${Math.random().toString(36).substr(2, 9)}`), o = {
      sm: "px-3 py-2 text-sm",
      // Same as Button sm
      md: "px-4 py-2.5 text-sm",
      // Same as Button md
    ...
    return (r, s) => (l(), a("div", null, [
      e.label ? (l(), a("label", {
        ...
        D(g(e.label) + " ", 1),
        e.required ? (l(), a("span", $e, "*")) : f("", !0)
      ], 10, ke)) : f("", !0),
      n("div", Ve, [
        n("select", {
          id: t.value,
          value: e.modelValue,
          onChange: s[0] || (s[0] = (i) => r.$emit("update:modelValue", i.target.value)),
          required: e.required,
          disabled: e.disabled,
          class: h([
          ...
          e.placeholder ? (l(), a("option", Le, g(e.placeholder), 1)) : f("", !0),
          (l(!0), a(j, null, E(e.options, (i) => (l(), a("option", {
            key: i.value,
            value: i.value,
            class: "text-gray-700 dark:bg-gray-900 dark:text-gray-400"
          }, g(i.label), 9, He))), 128))
        ], 42, Me),
        s[1] || (s[1] = n("span", { class: "absolute z-30 text-gray-700 -translate-y-1/2 pointer-events-none right-3 top-1/2 dark:text-gray-400" }, [
          n("svg", {
      ...
      e.error ? (l(), a("p", _e, g(e.error), 1)) : f("", !0)
    ]));
  }
}), Be = ["for"], Ze = {
  key: 0,
  ...
  emits: ["update:modelValue"],
  setup(e) {
    const t = y(() => `textarea-${Math.random().toString(36).substr(2, 9)}`);
    return (o, r) => (l(), a("div", null, [
      e.label ? (l(), a("label", {
        key: 0,
        for: t.value,
        class: h(["mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400", { "text-gray-300 dark:text-white/15": e.disabled }])
        ...
        D(g(e.label) + " ", 1),
        e.required ? (l(), a("span", Ze, "*")) : f("", !0)
      ], 10, Be)) : f("", !0),
      n("textarea", {
        id: t.value,
        value: e.modelValue,
        onInput: r[0] || (r[0] = (s) => o.$emit("update:modelValue", s.target.value)),
        placeholder: e.placeholder,
        required: e.required,
        disabled: e.disabled,
        rows: e.rows,
        class: h(["w-full rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800 disabled:border-gray-100 disabled:bg-gray-50 disabled:placeholder:text-gray-300 dark:disabled:border-gray-800 dark:disabled:bg-white/[0.03] dark:disabled:placeholder:text-white/15", e.error ? "border-error-300 focus:border-error-300 focus:ring-error-500/10 dark:border-error-700 dark:focus:border-error-800" : ""])
      }, null, 42, Se),
      e.error ? (l(), a("p", Ie, g(e.error), 1)) : f("", !0)
    ]));
  }
  ...
  emits: ["update:modelValue"],
  setup(e) {
    const t = y(() => `checkbox-${Math.random().toString(36).substr(2, 9)}`);
    return (o, r) => (l(), a("div", ze, [
      n("div", De, [
        n("input", {
          id: t.value,
          type: "checkbox",
          checked: e.modelValue,
          onChange: r[0] || (r[0] = (s) => o.$emit("update:modelValue", s.target.checked)),
          disabled: e.disabled,
      ...
      n("div", je, [
        e.label ? (l(), a("label", {
          key: 0,
          for: t.value,
          class: h(["text-sm font-medium text-gray-700 dark:text-gray-300", { "text-gray-400 dark:text-gray-600": e.disabled }])
        }, g(e.label), 11, Ee)) : f("", !0),
        e.description ? (l(), a("p", Ge, g(e.description), 1)) : f("", !0)
      ])
    ]));
  }
}), qe = ["for"], Pe = {
  ...
  emits: ["update:modelValue"],
  setup(e) {
    const t = y(() => `date-${Math.random().toString(36).substr(2, 9)}`);
    return (o, r) => (l(), a("div", null, [
      e.label ? (l(), a("label", {
        key: 0,
        for: t.value,
      ...
      n("div", Ae, [
        n("input", {
          ...
          min: e.min,
          max: e.max,
          class: h(["h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800 disabled:border-gray-100 disabled:bg-gray-50 disabled:text-gray-400 dark:disabled:border-gray-800 dark:disabled:bg-white/[0.03] dark:disabled:text-gray-500", e.error ? "border-error-300 focus:border-error-300 focus:ring-error-500/10 dark:border-error-700 dark:focus:border-error-800" : ""])
        }, null, 42, Fe),
        r[1] || (r[1] = n("span", { class: "absolute right-3.5 top-1/2 -translate-y-1/2 pointer-events-none text-gray-500 dark:text-gray-400" }, [
          n("svg", {
            width: "20",
            height: "20",
            viewBox: "0 0 20 20",
      ...
      e.error ? (l(), a("p", Oe, g(e.error), 1)) : f("", !0)
    ]));
  }
}), Re = ["for"], Ne = {
  key: 0,
  ...
  emits: ["update:modelValue"],
  setup(e) {
    const t = y(() => `time-${Math.random().toString(36).substr(2, 9)}`);
    return (o, r) => (l(), a("div", null, [
      e.label ? (l(), a("label", {
        key: 0,
        for: t.value,
      ...
      e.error ? (l(), a("p", Ke, g(e.error), 1)) : f("", !0)
    ]));
  }
  ...
  emits: ["update:modelValue"],
  setup(e) {
    return (t, o) => (l(), a("label", {
      class: h(["relative inline-flex items-center cursor-pointer", { "opacity-50 cursor-not-allowed": e.disabled }])
    }, [
      n("input", {
        type: "checkbox",
        checked: e.modelValue,
        onChange: o[0] || (o[0] = (r) => !e.disabled && t.$emit("update:modelValue", r.target.checked)),
        disabled: e.disabled,
        class: "sr-only peer"
      }, null, 40, Je),
      o[1] || (o[1] = n("div", { class: "w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-brand-300 dark:peer-focus:ring-brand-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-brand-500" }, null, -1)),
      e.label ? (l(), a("span", Xe, g(e.label), 1)) : f("", !0)
    ], 2));
  }
}), Qe = {
  key: 0,
  ...
  key: 0,
  class: "text-gray-400"
}, et = { class: "flex flex-wrap items-center flex-auto gap-2" }, tt = ["onClick"], rt = {
  key: 0,
...
}, lt = ["onClick", "aria-selected"], nt = { class: "grow" }, at = {
  key: 0,
  ...
  emits: ["update:modelValue"],
  setup(e, { emit: t }) {
    const o = e, r = t, s = z(!1), i = z(null), d = y(() => o.modelValue), c = () => {
      s.value = !s.value;
    }, u = (x) => {
      const p = d.value.findIndex((B) => B.value === x.value);
      let k;
      p === -1 ? k = [...d.value, x] : k = d.value.filter((B, L) => L !== p), r("update:modelValue", k);
    }, b = (x) => {
      const p = d.value.filter((k) => k.value !== x.value);
      r("update:modelValue", p);
    }, m = (x) => d.value.some((p) => p.value === x.value), C = (x) => {
      i.value && !i.value.contains(x.target) && (s.value = !1);
    };
    return l1(() => {
      ...
      n("div", {
        ...
        n("div", {
          ...
          n("div", et, [
            (l(!0), a(j, null, E(d.value, (k) => (l(), a("div", {
              ...
              n("span", null, g(k.label), 1),
              e.disabled ? f("", !0) : (l(), a("button", {
                key: 0,
                onClick: I1((B) => b(k), ["stop"]),
          ...
          (l(), a("svg", {
            class: h(["ml-auto shrink-0 transition-transform", { "rotate-180": s.value }]),
            width: "20",
            height: "20",
            viewBox: "0 0 20 20",
            fill: "none",
        ...
        R(r1, {
          ...
          default: S(() => [
            s.value ? (l(), a("div", rt, [
              n("ul", ot, [
                (l(!0), a(j, null, E(e.options, (k) => (l(), a("li", {
                  key: k.value,
                  onClick: (B) => u(k),
                  class: h(["relative flex items-center w-full px-3 py-2 cursor-pointer first:rounded-t-lg last:rounded-b-lg hover:bg-gray-50 dark:hover:bg-gray-800 dark:text-white", { "bg-gray-50 dark:bg-white/[0.03]": m(k) }]),
                  role: "option",
                  "aria-selected": m(k)
                }, [
                  n("span", nt, g(k.label), 1),
                  m(k) ? (l(), a("svg", at, [...p[3] || (p[3] = [
                    n("path", {
                      "stroke-linecap": "round",
                      "stroke-linejoin": "round",
                      "stroke-width": "2",
      ...
      e.error ? (l(), a("p", st, g(e.error), 1)) : f("", !0)
    ]));
  }
}), it = ["for"], dt = {
  key: 0,
  class: "text-error-500"
}, ct = ["id", "accept", "multiple", "disabled", "required"], ut = {
  key: 1,
  class: "mt-1.5 text-xs text-error-500"
}, gt = {
  key: 2,
  ...
  emits: ["change"],
  setup(e, { emit: t }) {
    const o = t, r = y(() => `file-${Math.random().toString(36).substr(2, 9)}`), s = (i) => {
      const d = i.target;
      o("change", d.files);
    };
    return (i, d) => (l(), a("div", null, [
  ...
  setup(e, { emit: t }) {
    const o = e, r = t, s = {
      ...
      !o.disabled && !o.loading && r("click", c);
    };
    return (c, u) => (l(), a("button", {
      class: h([
      ...
      ])])) : e.startIcon ? (l(), a("span", ht, [
        (l(), I(P(e.startIcon)))
      ])) : f("", !0),
      M(c.$slots, "default"),
      e.endIcon && !e.loading ? (l(), a("span", mt, [
        (l(), I(P(e.endIcon)))
      ])) : f("", !0)
    ], 10, ft));
  }
}), Ct = { class: "flex items-start gap-3" }, xt = {
  key: 0,
  width: "20",
  height: "20",
  viewBox: "0 0 20 20",
  ...
  setup(e) {
    ...
    return (o, r) => {
      const s = U1("router-link");
      return l(), a("div", {
        class: h(["rounded-xl border p-4", t[e.variant].container])
      }, [
        n("div", Ct, [
          n("div", {
            class: h(["-mt-0.5", t[e.variant].icon])
          }, [
            e.variant === "success" ? (l(), a("svg", xt, [...r[1] || (r[1] = [
              n("path", {
                "fill-rule": "evenodd",
                "clip-rule": "evenodd",
            ...
            ])])) : e.variant === "error" ? (l(), a("svg", vt, [...r[2] || (r[2] = [
              n("path", {
                "fill-rule": "evenodd",
                "clip-rule": "evenodd",
            ...
            ])])) : e.variant === "warning" ? (l(), a("svg", pt, [...r[3] || (r[3] = [
              n("path", {
                "fill-rule": "evenodd",
                "clip-rule": "evenodd",
          ...
          e.dismissible ? (l(), a("button", {
            key: 0,
            onClick: r[0] || (r[0] = (i) => o.$emit("dismiss")),
  ...
  key: 1,
  class: "ml-1"
}, Lt = "inline-flex items-center px-2.5 py-0.5 justify-center gap-1 rounded-full font-medium capitalize", Wl = /* @__PURE__ */ V({
  __name: "Badge",
  props: {
  ...
  setup(e) {
    ...
    }, s = y(() => o[t.size]), i = y(() => r[t.variant][t.color]);
    return (d, c) => (l(), a("span", {
      class: h([Lt, s.value, i.value])
    }, [
      e.startIcon ? (l(), a("span", Vt, [
        (l(), I(P(e.startIcon)))
      ])) : f("", !0),
      M(d.$slots, "default"),
      e.endIcon ? (l(), a("span", Mt, [
        (l(), I(P(e.endIcon)))
      ])) : f("", !0)
    ], 2));
  }
}), Ht = { class: "flex-shrink-0" }, _t = { class: "flex-1 min-w-0" }, Bt = { class: "text-sm font-medium" }, Zt = {
  key: 0,
  ...
  setup(e) {
    const t = {
      ...
      success: () => A("svg", { fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" }, [
        A("path", { "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", d: "M5 13l4 4L19 7" })
      ]),
      error: () => A("svg", { fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" }, [
        A("path", { "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", d: "M6 18L18 6M6 6l12 12" })
      ]),
      warning: () => A("svg", { fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" }, [
        A("path", { "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", d: "M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" })
      ]),
      info: () => A("svg", { fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" }, [
        A("path", { "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", d: "M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" })
      ])
    };
    return (c, u) => (l(), a("div", {
      class: h([
      ...
      n("div", Ht, [
        (l(), I(P(d[e.type]), { class: "h-5 w-5" }))
      ]),
      n("div", _t, [
        n("p", Bt, g(e.title), 1),
        e.message ? (l(), a("p", Zt, g(e.message), 1)) : f("", !0)
      ]),
      e.dismissible ? (l(), a("button", {
        key: 0,
        type: "button",
        class: "flex-shrink-0 rounded-md p-1 hover:bg-black/10 dark:hover:bg-white/10 transition-colors",
        onClick: u[0] || (u[0] = (b) => c.$emit("dismiss"))
      }, [...u[1] || (u[1] = [
        n("svg", {
          class: "h-4 w-4",
          fill: "none",
...
let It = 0;
function zt() {
  return `toast-${++It}-${Date.now()}`;
}
function i1(e) {
  const t = zt(), o = e.duration ?? 5e3, r = {
    id: t,
    type: e.type,
    title: e.title,
    message: e.message,
  ...
  return o1.value.push(r), o > 0 && setTimeout(() => {
    j1(t);
  }, o), t;
}
function j1(e) {
  const t = o1.value.findIndex((o) => o.id === e);
  t !== -1 && o1.value.splice(t, 1);
}
function Dt() {
  o1.value = [];
}
function Tt() {
  const e = (s) => i1({ ...s, type: "success" }), t = (s) => i1({ ...s, type: "error" }), o = (s) => i1({ ...s, type: "warning" }), r = (s) => i1({ ...s, type: "info" });
  return {
    toasts: K1(o1),
    success: e,
    error: t,
...
const Ul = /* @__PURE__ */ V({
  ...
  setup(e, { emit: t }) {
    const o = e, r = t, s = y(() => ({
      ...
      const u = "fixed inset-0 h-full w-full", b = o.blur ? "backdrop-blur-[32px]" : "";
      return `${u} ${b} bg-black/60 dark:bg-black/70`;
    }), d = () => {
      o.closeOnBackdrop && (r("update:modelValue", !1), r("close"));
    }, c = (u) => {
      u.key === "Escape" && o.closeOnEscape && o.modelValue && (r("update:modelValue", !1), r("close"));
    };
    return c1(() => o.modelValue, (u) => {
        ...
        default: S(() => [
          e.modelValue ? (l(), a("div", jt, [
            ...
            R(r1, {
              ...
              default: S(() => [
                e.modelValue ? (l(), a("div", {
                  key: 0,
                  class: h(["relative z-10", s.value])
                }, [
                  M(u.$slots, "default")
                ], 2)) : f("", !0)
              ]),
...
}), Gt = { class: "no-scrollbar overflow-y-auto rounded-3xl bg-white p-6 dark:bg-gray-900 lg:p-8" }, qt = { class: "mb-6" }, Pt = { class: "text-xl font-semibold text-gray-800 dark:text-white/90 lg:text-2xl" }, At = {
  key: 0,
  class: "mt-1 text-sm text-gray-500 dark:text-gray-400"
}, Ft = { class: "mt-6 flex items-center gap-3 sm:justify-end" }, Ot = ["disabled"], Rt = {
  key: 0,
  ...
  setup(e, { emit: t }) {
    const o = e, r = t, s = y({
      ...
      !o.loading && !o.confirmDisabled && r("confirm");
    }, c = () => {
      r("cancel"), r("close"), r("update:modelValue", !1);
    };
    return (u, b) => (l(), I(Et, {
      modelValue: s.value,
      "onUpdate:modelValue": b[0] || (b[0] = (m) => s.value = m),
      size: e.size,
      ...
      default: S(() => [
        n("div", Gt, [
          n("div", qt, [
            n("h5", Pt, g(e.title), 1),
            e.subtitle ? (l(), a("p", At, g(e.subtitle), 1)) : f("", !0)
          ]),
          n("div", null, [
            M(u.$slots, "default")
          ]),
          n("div", Ft, [
            ...
            n("button", {
              ...
              class: h(["flex w-full justify-center rounded-lg px-4 py-2.5 text-sm font-medium text-white sm:w-auto disabled:opacity-50", i.value])
            }, [
              e.loading ? (l(), a("svg", Rt, [...b[1] || (b[1] = [
                n("circle", {
                  class: "opacity-25",
                  cx: "12",
                  cy: "12",
              ...
              D(" " + g(e.loading ? e.loadingText : e.confirmText), 1)
            ], 10, Ot),
            M(u.$slots, "extra-buttons")
          ])
        ])
      ]),
      _: 3
  ...
  setup(e, { emit: t }) {
    ...
    return (d, c) => (l(), I(Nt, {
      ...
      variant: e.variant,
      size: "sm",
      onConfirm: c[1] || (c[1] = (u) => d.$emit("confirm")),
      onCancel: c[2] || (c[2] = (u) => d.$emit("cancel"))
    }, {
      default: S(() => [
        e.showIcon ? (l(), a("div", Wt, [
          n("div", {
            class: h(["flex h-12 w-12 items-center justify-center rounded-full", i.value])
          }, [
            e.variant === "danger" ? (l(), a("svg", Ut, [...c[3] || (c[3] = [
              n("path", {
                "stroke-linecap": "round",
                "stroke-linejoin": "round",
                "stroke-width": "2",
            ...
            ])])) : e.variant === "success" ? (l(), a("svg", Kt, [...c[4] || (c[4] = [
              n("path", {
                "stroke-linecap": "round",
                "stroke-linejoin": "round",
                "stroke-width": "2",
...
function Xt(e = {}) {
  const { initialExpanded: t = !0, mobileBreakpoint: o = 768 } = e, r = z(t), s = z(!1), i = z(!1), d = z(!1), c = z(null), u = z(null), b = () => {
    const H = window.innerWidth < o;
    i.value = H, H || (s.value = !1);
  };
  l1(() => {
  ...
  const m = () => {
    i.value ? s.value = !s.value : r.value = !r.value;
  }, C = () => {
    s.value = !s.value;
  }, x = () => {
    s.value = !1;
    ...
    isExpanded: y(() => i.value ? !1 : r.value),
    isMobileOpen: s,
    isHovered: d,
    activeItem: c,
    openSubmenu: u,
    toggleSidebar: m,
    toggleMobileSidebar: C,
...
const Qt = { class: "flex flex-col overflow-y-auto duration-300 ease-linear no-scrollbar flex-1" }, Yt = { class: "mb-6" }, e0 = {
  key: 0,
  class: "mt-auto"
}, t0 = /* @__PURE__ */ V({
  __name: "Sidebar",
  ...
  setup(e) {
    ...
    return (m, C) => (l(), a("aside", {
      ...
      n("div", {
        class: h([
          "py-8 flex",
          !$(o) && !$(s) ? "lg:justify-center" : "justify-start"
        ])
      }, [
        M(m.$slots, "logo", {
          isExpanded: $(o),
  ...
  setup(e) {
    const { toggleSidebar: t, toggleMobileSidebar: o, isMobileOpen: r } = u1(), s = z(!1), i = () => {
      typeof window < "u" && window.innerWidth >= 1024 ? t() : o();
    }, d = () => {
      s.value = !s.value;
    };
    return (c, u) => (l(), a("header", o0, [
      n("div", l0, [
        n("div", n0, [
          n("button", {
            type: "button",
            onClick: i,
            class: h(["flex items-center justify-center w-10 h-10 text-gray-500 border-gray-200 rounded-lg z-[9999] dark:border-gray-800 dark:text-gray-400 lg:h-11 lg:w-11 lg:border", [
              $(r) ? "lg:bg-transparent dark:lg:bg-transparent bg-gray-100 dark:bg-gray-800" : ""
            ]])
          }, [
            $(r) ? (l(), a("svg", a0, [...u[0] || (u[0] = [
              n("path", {
                "fill-rule": "evenodd",
                "clip-rule": "evenodd",
        ...
        n("div", {
          class: h([[s.value ? "flex" : "hidden"], "items-center justify-between w-full gap-4 px-5 py-4 shadow-theme-md lg:flex lg:justify-end lg:px-0 lg:shadow-none"])
        }, [
          M(c.$slots, "actions")
        ], 2)
      ])
  ...
  setup(e) {
    ...
    return (r, s) => (l(), a("div", u0, [
      M(r.$slots, "sidebar", {}, () => [
        R(r0, null, {
          logo: S((i) => [
            M(r.$slots, "sidebar-logo", m1(C1(i)))
          ]),
          default: S((i) => [
            M(r.$slots, "sidebar-nav", m1(C1(i)))
          ]),
          footer: S((i) => [
            M(r.$slots, "sidebar-footer", m1(C1(i)))
          ]),
          _: 3
        })
      ]),
      R(c0),
      n("div", {
        class: h(["flex-1 transition-all duration-300 ease-in-out", [$(t) || $(o) ? "lg:ml-[290px]" : "lg:ml-[90px]"]])
      }, [
        M(r.$slots, "header", {}, () => [
          R(d0, null, {
            logo: S(() => [
              M(r.$slots, "header-logo")
            ]),
            center: S(() => [
              M(r.$slots, "header-center")
            ]),
            actions: S(() => [
              M(r.$slots, "header-actions")
            ]),
            _: 3
          })
        ]),
  ...
  setup(e) {
    ...
    }), (o, r) => M(o.$slots, "default");
  }
}), G1 = Symbol("theme");
function f0(e = {}) {
  const { storageKey: t = "theme", defaultTheme: o = "light", syncWithSystem: r = !0 } = e, s = z(o), i = z(!1), d = y(() => s.value === "dark"), c = () => {
  ...
  l1(() => {
    ...
    let x = o;
    C && (C === "light" || C === "dark") ? x = C : r && window.matchMedia && window.matchMedia("(prefers-color-scheme: dark)").matches && (x = "dark"), s.value = x, b(x), i.value = !0, r && window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change", (p) => {
      if (!localStorage.getItem(t)) {
        const k = p.matches ? "dark" : "light";
        s.value = k, b(k);
      }
    });
  }), c1([s, i], ([C, x]) => {
    x && (localStorage.setItem(t, C), b(C));
  });
  const m = {
    theme: s,
    isDarkMode: d,
...
const Ql = /* @__PURE__ */ V({
  ...
  setup(e) {
    const t = e, o = y(() => t.initials ? t.initials : t.name ? t.name.split(" ").map((d) => d[0]).join("").toUpperCase().slice(0, 2) : "?"), r = {
    ...
    return (d, c) => (l(), a("div", {
      class: h(["relative rounded-full flex-shrink-0", r[e.size]])
    }, [
      e.src ? (l(), a("img", {
        key: 0,
        src: e.src,
  ...
  setup(e) {
    return (t, o) => (l(), a("div", {
      ...
      n("div", {
        class: h([
          "p-4 sm:p-6",
          (e.title || t.$slots.header) && "border-t border-gray-100 dark:border-gray-800"
        ])
      }, [
        n("div", {
...
const y0 = { class: "relative p-4 flex flex-col items-center" }, w0 = { class: "text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2" }, k0 = { class: "relative w-40 h-24" }, $0 = {
  viewBox: "0 0 160 90",
  class: "w-full h-full"
}, V0 = ["stroke-dashoffset"], M0 = { class: "absolute inset-0 flex flex-col items-center justify-end pb-0" }, L0 = { class: "flex items-baseline gap-0.5" }, H0 = { class: "text-xs text-gray-400 dark:text-gray-500" }, _0 = {
  key: 0,
  ...
  setup(e) {
    ...
    ), s = y(() => t.value === null || t.max <= 0 ? 0 : Math.min(100, Math.max(0, t.value / t.max * 100))), i = y(() => t.value === null ? "--" : t.value.toLocaleString(t.locale)), d = y(() => t.adaptive ? q1(s.value, t.color, t.thresholds) : t.color), c = y(() => J[d.value]), u = Math.PI * z0, b = y(
      () => u - s.value / 100 * u
    );
    return (m, C) => (l(), I(K, {
      "class-name": `group relative overflow-hidden ${c.value.hoverBorder} transition-colors ${e.className ?? ""}`,
      "content-class": "!p-0"
    }, {
      default: S(() => [
        n("div", {
          class: h(`absolute inset-0 bg-gradient-to-br ${c.value.gradient} to-transparent`)
        }, null, 2),
        n("div", y0, [
          ...
          n("div", k0, [
            (l(), a("svg", $0, [
              n("path", {
                ...
                fill: "none",
                class: h(`${c.value.trackLight} ${c.value.trackDark}`),
                "stroke-width": _1,
                "stroke-linecap": "round"
              }, null, 2),
              n("path", {
                d: "M 10 80 A 70 70 0 0 1 150 80",
                fill: "none",
                class: h([c.value.bar, "transition-all duration-700 ease-out"]),
                "stroke-width": _1,
                "stroke-linecap": "round",
                "stroke-dasharray": u,
            ...
            n("div", M0, [
              n("div", L0, [
                n("span", {
                  class: h(`text-2xl font-bold tabular-nums ${c.value.textLight} ${c.value.textDark}`)
                }, g(i.value), 3),
  ...
  setup(e) {
    const t = e, o = y(() => t.value === null || t.max <= 0 ? 0 : Math.min(100, Math.max(0, t.value / t.max * 100))), r = y(() => Math.round(t.value ?? 0)), s = y(() => t.adaptive ? q1(o.value, t.color, t.thresholds) : t.color), i = y(() => J[s.value]), d = y(() => {
      const c = [];
      for (let u = 0; u <= t.scaleDivisions; u++)
        c.push(Math.round(t.max / t.scaleDivisions * u));
      return c;
    });
    return (c, u) => (l(), I(P(e.wrapped ? K : "div"), {
      ...
      default: S(() => [
        ...
        n("div", {
          class: h(e.wrapped ? "px-5 pb-5" : "")
        }, [
          n("div", {
            class: h(`relative w-full ${e.barHeight} bg-gray-200 dark:bg-gray-800 rounded-full overflow-hidden`)
          }, [
            n("div", {
          ...
          e.showScale ? (l(), a("div", R0, [
            (l(!0), a(j, null, E(d.value, (b) => (l(), a("span", { key: b }, g(b) + g(e.unit), 1))), 128))
          ])) : f("", !0)
        ], 2)
      ]),
      _: 2
  ...
  setup(e) {
    const t = e, o = y(() => J[t.color]), r = y(() => {
      if (t.value === null || t.value === void 0) return "--";
      if (typeof t.value == "string") return t.value;
      const s = t.absolute ? Math.abs(t.value) : t.value;
      return Math.round(s).toLocaleString(t.locale);
    });
    return (s, i) => (l(), I(K, {
      "class-name": `group relative overflow-hidden ${o.value.hoverBorder} transition-colors ${e.className ?? ""}`,
      "content-class": "!p-0"
    }, {
      default: S(() => [
        n("div", {
        ...
        n("div", N0, [
          ...
          e.subtitle ? (l(), a("div", {
            key: 0,
            class: h(`text-xs mt-1 ${e.subtitleColor || "text-gray-400 dark:text-gray-500"}`)
          }, g(e.subtitle), 3)) : f("", !0)
        ])
      ]),
      _: 3
  ...
  setup(e) {
    function t(s) {
      ...
      const i = s.decimals ?? 1, d = (Math.round(s.value * Math.pow(10, i)) / Math.pow(10, i)).toFixed(
        i
      );
      return s.unit ? `${d} ${s.unit}` : d;
    }
    function o(s) {
      if (s.value === null) return 0;
      const i = s.max ?? 100;
      return Math.min(100, Math.max(0, s.value / i * 100));
    }
    function r(s) {
      return J[s.color ?? "sky"];
    }
    return (s, i) => (l(), I(K, {
      "class-name": e.className,
      ...
      default: S(() => [
        (l(!0), a(j, null, E(e.rows, (d, c) => (l(), a("div", { key: c }, [
          n("div", X0, [
            n("span", Q0, g(d.label), 1),
            n("span", {
              class: h(`text-sm font-medium tabular-nums ${r(d).textLight} ${r(d).textDark}`)
            }, g(t(d)), 3)
          ]),
          n("div", Y0, [
            n("div", {
              class: h(`h-full rounded-full ${r(d).barSolid} transition-all duration-700`),
              style: U({ width: `${o(d)}%` })
            }, null, 6)
          ])
        ]))), 128)),
  ...
  setup(e) {
    const t = e, o = d1(), r = y(() => J[t.color]), s = y(() => t.items.length === 0 ? 1 : Math.max(...t.items.map((b) => b.value), 1));
    function i(b) {
    ...
    function c(b) {
      return b <= 0 ? "0%" : `${Math.max(t.minBarPercent, b / s.value * 100)}%`;
    }
    const u = y(() => {
      if (!t.showGroupBoundary) return /* @__PURE__ */ new Set();
      const b = /* @__PURE__ */ new Set();
      for (let m = 1; m < t.items.length; m++)
        t.items[m].group !== void 0 && t.items[m - 1].group !== void 0 && t.items[m].group !== t.items[m - 1].group && b.add(m);
      return b;
    });
    return (b, m) => (l(), I(K, {
      "class-name": `group relative overflow-hidden ${r.value.hoverBorder} transition-colors ${e.className ?? ""}`,
      "content-class": "!p-0"
    }, {
      default: S(() => [
        n("div", {
          ...
          e.items.length > 0 ? (l(), a("div", {
            ...
            (l(!0), a(j, null, E(e.items, (C, x) => {
              ...
              return l(), a("div", {
                ...
                e.showValues && C.value > 0 ? (l(), a("span", or, g(d(C.value)), 1)) : f("", !0),
                n("div", lr, [
                  n("div", {
    ...
    return (s, i) => (l(), I(K, {
      ...
      default: S(() => [
        ...
        n("div", ar, [
          ...
          n("div", ir, [
            (l(!0), a(j, null, E(e.rows, (d, c) => (l(), a("div", {
              key: c,
              class: h(["flex items-center justify-between py-1", e.showSeparators && c < e.rows.length - 1 ? "border-b border-gray-100 dark:border-gray-800/50" : ""])
            }, [
              n("span", dr, g(d.label), 1),
              n("span", {
                class: h(`text-sm font-medium tabular-nums ${d.accent ? `${r.value.textLight} ${r.value.textDark}` : "text-gray-700 dark:text-gray-300"}`)
              }, g(d.value), 3)
            ], 2))), 128))
          ]),
          $(o).footer ? (l(), a("div", cr, [
      ...
      n("nav", fr, [
        n("ol", br, [
          (l(!0), a(j, null, E(e.items, (r, s) => (l(), a("li", {
            ...
            r.href && s < e.items.length - 1 ? (l(), I(P(e.linkComponent), {
              key: 0,
              href: r.href,
              to: r.to,
...
const Cr = ["onClick"], dn = /* @__PURE__ */ V({
  ...
  emits: ["select"],
  setup(e, { emit: t }) {
    const o = t, r = z(!1), s = z(null), i = () => {
      r.value = !r.value;
    }, d = () => {
      r.value = !1;
    }, c = (u) => {
      u.disabled || (u.onClick && u.onClick(), o("select", u), d());
    };
    return mr(s, d), (u, b) => (l(), a("div", {
      class: "relative",
      ref_key: "dropdownRef",
      ref: s
    }, [
      ...
      R(r1, {
        ...
        default: S(() => [
          r.value ? (l(), a("div", {
            ...
            M(u.$slots, "menu", { close: d }, () => [
              (l(!0), a(j, null, E(e.items, (m, C) => (l(), a("button", {
                key: C,
                type: "button",
                onClick: (x) => c(m),
                class: h(e.itemClass)
...
const Vr = /* @__PURE__ */ v(wr, [["render", $r]]), Mr = {}, Lr = {
  width: "20",
  height: "20",
  viewBox: "0 0 20 20",
  fill: "none",
...
const _r = /* @__PURE__ */ v(Mr, [["render", Hr]]), Br = {}, Zr = {
  width: "24",
  height: "24",
  viewBox: "0 0 24 24",
  fill: "none",
...
const L5 = /* @__PURE__ */ v($5, [["render", M5]]), H5 = {}, _5 = {
  width: "24",
  height: "24",
  viewBox: "0 0 24 24",
  fill: "none",
...
const Mo = /* @__PURE__ */ v(ko, [["render", Vo]]), Lo = {}, Ho = {
  width: "24",
  height: "24",
  viewBox: "0 0 24 24",
  fill: "none",
...
const Bo = /* @__PURE__ */ v(Lo, [["render", _o]]), Zo = {}, So = {
  width: "16",
  height: "16",
  viewBox: "0 0 16 16",
  fill: "none",
...
const $2 = /* @__PURE__ */ v(y2, [["render", k2]]), V2 = {}, M2 = {
  width: "20",
  height: "20",
  viewBox: "0 0 20 20",
  fill: "none",
...
const H2 = /* @__PURE__ */ v(V2, [["render", L2]]), _2 = {}, B2 = {
  width: "24",
  height: "24",
  viewBox: "0 0 24 24",
  fill: "none",
...
const O2 = /* @__PURE__ */ v(P2, [["render", F2]]), B1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  setup(e) {
    const t = e, o = z(""), r = z(null), s = y(() => {
      const b = Object.keys(B1).filter(
        (m) => m.endsWith("Icon") || m === "HorizontalDots"
      );
      return t.filter && t.filter.length > 0 ? b.filter((m) => t.filter.includes(m)) : b;
    }), i = y(() => {
      if (!o.value) return s.value;
      const b = o.value.toLowerCase();
      return s.value.filter((m) => m.toLowerCase().includes(b));
    }), d = (b) => B1[b], c = async (b) => {
      const m = `import { ${b} } from '@four-bytes/four-tailwind-ui'`;
      try {
        await navigator.clipboard.writeText(m), r.value = b, setTimeout(() => {
          r.value = null;
        }, 2e3);
      } catch (C) {
    ...
    return (b, m) => (l(), a("div", R2, [
      ...
      n("div", {
        ...
        (l(!0), a(j, null, E(i.value, (C) => (l(), a("div", {
          key: C,
          class: h(["icon-gallery-card", { "icon-gallery-card--copied": r.value === C }]),
          onClick: (x) => c(C),
          title: `Click to copy import for ${C}`,
          role: "button",
          tabindex: "0",
          onKeydown: ee((x) => c(C), ["enter"])
        }, [
          n("div", {
...
function P1(e) {
  ...
  if (typeof e == "string" || typeof e == "number") r += e;
    ...
    var s = e.length;
    for (t = 0; t < s; t++) e[t] && (o = P1(e[t])) && (r && (r += " "), r += o);
...
const y1 = "-", el = (e) => {
  ...
  return {
    getClassGroupId: (d) => {
      const c = d.split(y1);
      return c[0] === "" && c.length !== 1 && c.shift(), A1(c, t) || tl(d);
    },
    getConflictingClassGroupIds: (d, c) => {
      const u = o[d] || [];
      return c && r[d] ? [...u, ...r[d]] : u;
    }
  };
}, A1 = (e, t) => {
  var d;
  ...
  const o = e[0], r = t.nextPart.get(o), s = r ? A1(e.slice(1), r) : void 0;
  if (s)
    return s;
  ...
  return (d = t.validators.find(({
    validator: c
  }) => c(i))) == null ? void 0 : d.classGroupId;
}, Z1 = /^\[(.+)\]$/, tl = (e) => {
  if (Z1.test(e)) {
  ...
  return ll(Object.entries(e.classGroups), o).forEach(([i, d]) => {
    v1(d, r, i, t);
  }), r;
}, v1 = (e, t, o, r) => {
  e.forEach((s) => {
  ...
  const s = r.map((i) => typeof i == "string" ? t + i : typeof i == "object" ? Object.fromEntries(Object.entries(i).map(([d, c]) => [t + d, c])) : i);
  return [o, s];
}) : e, nl = (e) => {
  if (e < 1)
    return {
  ...
  const s = (i, d) => {
    o.set(i, d), t++, t > e && (t = 0, r = o, o = /* @__PURE__ */ new Map());
  };
  return {
    get(i) {
      let d = o.get(i);
  ...
  const {
  ...
  } = e, r = t.length === 1, s = t[0], i = t.length, d = (c) => {
    const u = [];
    let b = 0, m = 0, C;
    for (let L = 0; L < c.length; L++) {
      let H = c[L];
      if (b === 0) {
        if (H === s && (r || c.slice(L, L + i) === t)) {
          u.push(c.slice(m, L)), m = L + i;
          continue;
        }
        if (H === "/") {
          C = L;
    ...
    const x = u.length === 0 ? c : c.substring(m), p = x.startsWith(F1), k = p ? x.substring(1) : x, B = C && C > m ? C - m : void 0;
    return {
      modifiers: u,
  ...
  for (let u = d.length - 1; u >= 0; u -= 1) {
    ...
    let k = !!p, B = r(k ? x.substring(0, p) : x);
    if (!B) {
      if (!k) {
        c = b + (c.length > 0 ? " " + c : c);
        continue;
    ...
    const L = sl(m).join(":"), H = C ? L + F1 : L, T = H + B;
    if (i.includes(T))
      continue;
    i.push(T);
    const Q = s(B, k);
...
function gl(e, ...t) {
  ...
  function d(u) {
    ...
    return o = il(b), r = o.cache.get, s = o.cache.set, i = c, c(u);
  }
  function c(u) {
    const b = r(u);
    if (b)
...
const _ = (e) => {
...
}, R1 = /^\[(?:([a-z-]+):)?(.+)\]$/i, fl = /^\d+\/\d+$/, bl = /* @__PURE__ */ new Set(["px", "full", "screen"]), hl = /^(\d+(\.\d+)?)?(xs|sm|md|lg|xl)$/, ml = /\d+(%|px|r?em|[sdl]?v([hwib]|min|max)|pt|pc|in|cm|mm|cap|ch|ex|r?lh|cq(w|h|i|b|min|max))|\b(calc|min|max|clamp)\(.+\)|^0$/, Cl = /^(rgba?|hsla?|hwb|(ok)?(lab|lch)|color-mix)\(.+\)$/, xl = /^(inset_)?-?((\d+)?\.?(\d+)[a-z]+|0)_-?((\d+)?\.?(\d+)[a-z]+|0)/, vl = /^(url|image|image-set|cross-fade|element|(repeating-)?(linear|radial|conic)-gradient)\(.+\)$/, q = (e) => W(e) || bl.has(e) || fl.test(e), F = (e) => X(e, "length", Ll), W = (e) => !!e && !Number.isNaN(Number(e)), x1 = (e) => X(e, "number", W), e1 = (e) => !!e && Number.isInteger(Number(e)), pl = (e) => e.endsWith("%") && W(e.slice(0, -1)), w = (e) => R1.test(e), O = (e) => hl.test(e), yl = /* @__PURE__ */ new Set(["length", "size", "percentage"]), wl = (e) => X(e, yl, N1), kl = (e) => X(e, "position", N1), $l = /* @__PURE__ */ new Set(["image", "url"]), Vl = (e) => X(e, $l, _l), Ml = (e) => X(e, "", Hl), t1 = () => !0, X = (e, t, o) => {
  const r = R1.exec(e);
  ...
  const e = _("colors"), t = _("spacing"), o = _("blur"), r = _("brightness"), s = _("borderColor"), i = _("borderRadius"), d = _("borderSpacing"), c = _("borderWidth"), u = _("contrast"), b = _("grayscale"), m = _("hueRotate"), C = _("invert"), x = _("gap"), p = _("gradientColorStops"), k = _("gradientColorStopPositions"), B = _("inset"), L = _("margin"), H = _("opacity"), T = _("padding"), Q = _("saturate"), N = _("scale"), n1 = _("sepia"), w1 = _("skew"), k1 = _("space"), $1 = _("translate"), g1 = () => ["auto", "contain", "none"], f1 = () => ["auto", "hidden", "clip", "visible", "scroll"], b1 = () => ["auto", w, t], Z = () => [w, t], V1 = () => ["", q, F], a1 = () => ["auto", W, w], M1 = () => ["bottom", "center", "left", "left-bottom", "left-top", "right", "right-bottom", "right-top", "top"], s1 = () => ["solid", "dashed", "dotted", "double", "none"], L1 = () => ["normal", "multiply", "screen", "overlay", "darken", "lighten", "color-dodge", "color-burn", "hard-light", "soft-light", "difference", "exclusion", "hue", "saturation", "color", "luminosity"], h1 = () => ["start", "end", "center", "between", "around", "evenly", "stretch"], Y = () => ["", "0", w], H1 = () => ["auto", "avoid", "all", "avoid-page", "page", "left", "right", "column"], G = () => [W, w];
  return {
    cacheSize: 500,
    separator: ":",
    theme: {
    ...
    classGroups: {
       ...
       */
      "font-weight": [{
        font: ["thin", "extralight", "light", "normal", "medium", "semibold", "bold", "extrabold", "black", x1]
      }],
      /**
       * Font Family
       ...
       */
      leading: [{
        leading: ["none", "tight", "snug", "normal", "relaxed", "loose", q, w]
      }],
      /**
       * List Style Image
       ...
       */
      "mix-blend": [{
        "mix-blend": [...L1(), "plus-lighter", "plus-darker"]
      }],
      /**
