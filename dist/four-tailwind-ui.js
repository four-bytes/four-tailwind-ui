import { defineComponent as L, useId as q, computed as w, openBlock as o, createElementBlock as n, normalizeClass as g, unref as d, createTextVNode as D, toDisplayString as m, createCommentVNode as h, createElementVNode as l, useSlots as fe, renderSlot as M, ref as T, watch as be, Fragment as A, renderList as E, onMounted as Y, onBeforeUnmount as e1, withModifiers as Ae, createVNode as O, Transition as ne, withCtx as Z, createBlock as S, resolveDynamicComponent as G, resolveComponent as Ee, h as R, readonly as t1, Teleport as Ge, TransitionGroup as r1, nextTick as o1, onUnmounted as he, inject as qe, provide as Pe, normalizeProps as pe, guardReactiveProps as ye, createSlots as s1, normalizeStyle as U, withDirectives as l1, vModelText as a1, withKeys as n1 } from "vue";
...
function Oe(e) {
  ...
  if (typeof e == "string" || typeof e == "number") s += e;
    ...
    var a = e.length;
    for (t = 0; t < a; t++) e[t] && (r = Oe(e[t])) && (s && (s += " "), s += r);
  } else for (r in e) e[r] && (s && (s += " "), s += r);
  return s;
}
function i1() {
  for (var e, t, r = 0, s = "", a = arguments.length; r < a; r++) (e = arguments[r]) && (t = Oe(e)) && (s && (s += " "), s += t);
  return s;
}
const $e = "-", d1 = (e) => {
  const t = u1(e), {
  ...
  const r = e[0], s = t.nextPart.get(r), a = s ? Re(e.slice(1), s) : void 0;
  if (a)
    return a;
  ...
  let r = e;
  return t.split($e).forEach((s) => {
    r.nextPart.has(s) || r.nextPart.set(s, {
      nextPart: /* @__PURE__ */ new Map(),
      validators: []
    }), r = r.nextPart.get(s);
  }), r;
}, g1 = (e) => e.isThemeGetter, f1 = (e, t) => t ? e.map(([r, s]) => {
  const a = s.map((i) => typeof i == "string" ? t + i : typeof i == "object" ? Object.fromEntries(Object.entries(i).map(([u, c]) => [t + u, c])) : i);
  return [r, a];
}) : e, b1 = (e) => {
  if (e < 1)
    return {
  ...
  const a = (i, u) => {
    r.set(i, u), t++, t > e && (t = 0, s = r, r = /* @__PURE__ */ new Map());
  };
  return {
    get(i) {
      let u = r.get(i);
  ...
  const {
  ...
  } = e, s = t.length === 1, a = t[0], i = t.length, u = (c) => {
    const f = [];
    let x = 0, b = 0, p;
    for (let B = 0; B < c.length; B++) {
      let _ = c[B];
      if (x === 0) {
        if (_ === a && (s || c.slice(B, B + i) === t)) {
          f.push(c.slice(b, B)), b = B + i;
          continue;
        }
        if (_ === "/") {
          p = B;
    ...
    const v = f.length === 0 ? c : c.substring(b), y = v.startsWith(We), V = y ? v.substring(1) : v, H = p && p > b ? p - b : void 0;
    return {
      modifiers: f,
  ...
  for (let f = u.length - 1; f >= 0; f -= 1) {
    ...
    let V = !!y, H = s(V ? v.substring(0, y) : v);
    if (!H) {
      if (!V) {
        c = x + (c.length > 0 ? " " + c : c);
        continue;
    ...
    const B = m1(b).join(":"), _ = p ? B + We : B, j = _ + H;
    if (i.includes(j))
      continue;
    i.push(j);
    const oe = a(H, V);
...
const Ne = (e) => {
  ...
  for (let s = 0; s < e.length; s++)
    e[s] && (t = Ne(e[s])) && (r && (r += " "), r += t);
  return r;
};
function y1(e, ...t) {
  let r, s, a, i = u;
  function u(f) {
    const x = t.reduce((b, p) => p(b), e());
    return r = C1(x), s = r.cache.get, a = r.cache.set, i = c, c(f);
  }
  function c(f) {
    const x = s(f);
    if (x)
...
const I = (e) => {
...
}, Ke = /^\[(?:([a-z-]+):)?(.+)\]$/i, k1 = /^\d+\/\d+$/, w1 = /* @__PURE__ */ new Set(["px", "full", "screen"]), $1 = /^(\d+(\.\d+)?)?(xs|sm|md|lg|xl)$/, V1 = /\d+(%|px|r?em|[sdl]?v([hwib]|min|max)|pt|pc|in|cm|mm|cap|ch|ex|r?lh|cq(w|h|i|b|min|max))|\b(calc|min|max|clamp)\(.+\)|^0$/, L1 = /^(rgba?|hsla?|hwb|(ok)?(lab|lch)|color-mix)\(.+\)$/, M1 = /^(inset_)?-?((\d+)?\.?(\d+)[a-z]+|0)_-?((\d+)?\.?(\d+)[a-z]+|0)/, H1 = /^(url|image|image-set|cross-fade|element|(repeating-)?(linear|radial|conic)-gradient)\(.+\)$/, F = (e) => X(e) || w1.has(e) || k1.test(e), W = (e) => ee(e, "length", D1), X = (e) => !!e && !Number.isNaN(Number(e)), ke = (e) => ee(e, "number", X), le = (e) => !!e && Number.isInteger(Number(e)), B1 = (e) => e.endsWith("%") && X(e.slice(0, -1)), $ = (e) => Ke.test(e), N = (e) => $1.test(e), _1 = /* @__PURE__ */ new Set(["length", "size", "percentage"]), Z1 = (e) => ee(e, _1, Ue), S1 = (e) => ee(e, "position", Ue), I1 = /* @__PURE__ */ new Set(["image", "url"]), z1 = (e) => ee(e, I1, A1), T1 = (e) => ee(e, "", j1), ae = () => !0, ee = (e, t, r) => {
  const s = Ke.exec(e);
  ...
  V1.test(e) && !L1.test(e)
), Ue = () => !1, j1 = (e) => M1.test(e), A1 = (e) => H1.test(e), E1 = () => {
  const e = I("colors"), t = I("spacing"), r = I("blur"), s = I("brightness"), a = I("borderColor"), i = I("borderRadius"), u = I("borderSpacing"), c = I("borderWidth"), f = I("contrast"), x = I("grayscale"), b = I("hueRotate"), p = I("invert"), v = I("gap"), y = I("gradientColorStops"), V = I("gradientColorStopPositions"), H = I("inset"), B = I("margin"), _ = I("opacity"), j = I("padding"), oe = I("saturate"), K = I("scale"), de = I("sepia"), Ve = I("skew"), Le = I("space"), Me = I("translate"), me = () => ["auto", "contain", "none"], Ce = () => ["auto", "hidden", "clip", "visible", "scroll"], xe = () => ["auto", $, t], z = () => [$, t], He = () => ["", F, W], ce = () => ["auto", X, $], Be = () => ["bottom", "center", "left", "left-bottom", "left-top", "right", "right-bottom", "right-top", "top"], ue = () => ["solid", "dashed", "dotted", "double", "none"], _e = () => ["normal", "multiply", "screen", "overlay", "darken", "lighten", "color-dodge", "color-burn", "hard-light", "soft-light", "difference", "exclusion", "hue", "saturation", "color", "luminosity"], ve = () => ["start", "end", "center", "between", "around", "evenly", "stretch"], se = () => ["", "0", $], Ze = () => ["auto", "avoid", "all", "avoid-page", "page", "left", "right", "column"], P = () => [X, $];
  return {
    cacheSize: 500,
    separator: ":",
    theme: {
      ...
      gradientColorStopPositions: [B1, W],
      inset: xe(),
      margin: xe(),
      opacity: P(),
      padding: z(),
...
const q1 = ["for"], P1 = {
...
}, N1 = ["id"], K1 = ["id"], U1 = ["id"], Kl = /* @__PURE__ */ L({
  inheritAttrs: !1,
  __name: "InputField",
  props: {
    modelValue: {},
  ...
  setup(e) {
    ...
    return (c, f) => (o(), n("div", {
      ...
      e.label ? (o(), n("label", {
        key: 0,
        for: d(r),
        class: g(["mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400", d(C)(e.disabled && "text-gray-300 dark:text-white/15")])
      }, [
        D(m(e.label) + " ", 1),
        e.required ? (o(), n("span", P1, "*")) : h("", !0)
      ], 10, q1)) : h("", !0),
      l("div", F1, [
        l("input", {
          id: d(r),
          "aria-describedby": e.error || e.success || e.hint ? d(s) : void 0,
        ...
        e.showStateIcon && e.success && !e.error ? (o(), n("span", W1, [...f[2] || (f[2] = [
          l("svg", {
            width: "16",
            height: "16",
            viewBox: "0 0 16 16",
      ...
      }, m(e.error), 9, N1)) : e.success ? (o(), n("p", {
        key: 2,
        id: d(s),
        class: "mt-1.5 text-xs text-success-500"
      }, m(e.success), 9, K1)) : e.hint ? (o(), n("p", {
        key: 3,
        id: d(s),
  ...
  setup(e) {
    ...
    return (i, u) => (o(), n("div", {
      ...
      e.error ? (o(), n("p", rt, m(e.error), 1)) : h("", !0)
    ], 2));
  }
}), ot = ["for"], st = {
  key: 0,
  ...
  setup(e, { emit: t }) {
    const r = e, s = t, a = q(), i = T(!1), u = T(""), c = /^[^\s@]+@[^\s@]+\.[^\s@]+$/, f = w(() => r.error ? r.error : i.value && u.value ? u.value : "");
    function x(v) {
      var y, V;
      return !v && r.required ? (u.value = ((y = r.errorMessages) == null ? void 0 : y.required) || "Email is required", !1) : v && !c.test(v) ? (u.value = ((V = r.errorMessages) == null ? void 0 : V.invalid) || "Please enter a valid email address", !1) : (u.value = "", !0);
    }
    function b(v) {
      const y = v.target.value;
      s("update:modelValue", y), i.value && c.test(y) && (u.value = "", s("validation", !0));
    }
    function p() {
      i.value = !0;
      const v = x(r.modelValue);
      s("validation", v);
    }
    return be(
      () => r.modelValue,
      ...
      e.label ? (o(), n("label", {
        ...
        D(m(e.label) + " ", 1),
        e.required ? (o(), n("span", st, "*")) : h("", !0)
      ], 10, ot)) : h("", !0),
      l("div", lt, [
        y[0] || (y[0] = l("span", { class: "absolute left-0 top-1/2 -translate-y-1/2 border-r border-gray-200 px-3.5 py-3 text-gray-500 dark:border-gray-800 dark:text-gray-400" }, [
          l("svg", {
            width: "20",
            height: "20",
            viewBox: "0 0 20 20",
      ...
      f.value ? (o(), n("p", nt, m(f.value), 1)) : h("", !0)
    ], 2));
  }
}), it = ["for"], dt = {
  key: 0,
    ...
    return (a, i) => (o(), n("div", {
      ...
      l("div", ct, [
        l("select", {
          ...
          e.placeholder ? (o(), n("option", gt, m(e.placeholder), 1)) : h("", !0),
        ...
        i[1] || (i[1] = l("span", { class: "absolute z-30 text-gray-700 -translate-y-1/2 pointer-events-none right-3 top-1/2 dark:text-gray-400" }, [
          l("svg", {
      ...
      e.error ? (o(), n("p", bt, m(e.error), 1)) : h("", !0)
    ], 2));
  }
}), ht = ["for"], mt = {
  key: 0,
  ...
  setup(e) {
    ...
    return (s, a) => (o(), n("div", {
      ...
      e.error ? (o(), n("p", xt, m(e.error), 1)) : h("", !0)
    ], 2));
  }
  ...
  setup(e) {
    const t = e, r = q();
    return (s, a) => (o(), n("div", {
      class: g(d(C)("flex items-start gap-3", t.class))
    }, [
      l("div", vt, [
        l("input", {
          id: d(r),
      ...
      l("div", yt, [
        e.label ? (o(), n("label", {
          key: 0,
          for: d(r),
          class: g(["text-sm font-medium text-gray-700 dark:text-gray-300", d(C)(e.disabled && "text-gray-400 dark:text-gray-600")])
        }, m(e.label), 11, kt)) : h("", !0),
        e.description ? (o(), n("p", wt, m(e.description), 1)) : h("", !0)
      ])
    ], 2));
  }
}), $t = ["for"], Vt = {
  ...
  setup(e) {
    ...
    return (s, a) => (o(), n("div", {
      ...
      l("div", Lt, [
        ...
        a[1] || (a[1] = l("span", { class: "absolute right-3.5 top-1/2 -translate-y-1/2 pointer-events-none text-gray-500 dark:text-gray-400" }, [
          l("svg", {
            width: "20",
            height: "20",
            viewBox: "0 0 20 20",
      ...
      e.error ? (o(), n("p", Ht, m(e.error), 1)) : h("", !0)
    ], 2));
  }
}), Bt = ["for"], _t = {
  key: 0,
  ...
  setup(e) {
    ...
    return (s, a) => (o(), n("div", {
      ...
      e.error ? (o(), n("p", It, m(e.error), 1)) : h("", !0)
    ], 2));
  }
}), zt = ["checked", "disabled"], Tt = {
  key: 0,
  ...
  setup(e) {
    ...
    return (r, s) => (o(), n("label", {
      ...
      l("input", {
        type: "checkbox",
        checked: e.modelValue,
        onChange: s[0] || (s[0] = (a) => !e.disabled && r.$emit("update:modelValue", a.target.checked)),
        disabled: e.disabled,
        class: "sr-only peer"
      }, null, 40, zt),
      s[1] || (s[1] = l("div", { class: "w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-brand-300 dark:peer-focus:ring-brand-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-brand-500" }, null, -1)),
      e.label ? (o(), n("span", Tt, m(e.label), 1)) : h("", !0)
    ], 2));
  }
}), Dt = {
  key: 0,
  ...
  emits: ["update:modelValue"],
  setup(e, { emit: t }) {
    const r = e, s = t, a = T(!1), i = T(null), u = w(() => r.modelValue), c = () => {
      a.value = !a.value;
    }, f = (v) => {
      ...
      let V;
      y === -1 ? V = [...u.value, v] : V = u.value.filter((H, B) => B !== y), s("update:modelValue", V);
    }, x = (v) => {
      const y = u.value.filter(
        (V) => V.value !== v.value
      );
      s("update:modelValue", y);
    }, b = (v) => u.value.some((y) => y.value === v.value), p = (v) => {
      i.value && !i.value.contains(v.target) && (a.value = !1);
    };
    return Y(() => {
      ...
      l("div", {
        ...
        l("div", {
          ...
          u.value.length === 0 ? (o(), n("span", jt, m(e.placeholder || "Select items..."), 1)) : h("", !0),
          l("div", At, [
            (o(!0), n(A, null, E(u.value, (V) => (o(), n("div", {
              ...
              l("span", null, m(V.label), 1),
              e.disabled ? h("", !0) : (o(), n("button", {
                key: 0,
                onClick: Ae((H) => x(V), ["stop"]),
          ...
          (o(), n("svg", {
            class: g(["ml-auto shrink-0 transition-transform", d(C)(a.value && "rotate-180")]),
            width: "20",
            height: "20",
            viewBox: "0 0 20 20",
            fill: "none",
                ...
                (o(!0), n(A, null, E(e.options, (V) => (o(), n("li", {
                  ...
                  class: g(
                    d(C)(
                      ...
                      b(V) && "bg-gray-50 dark:bg-white/[0.03]"
                    )
                  ),
                  role: "option",
                  "aria-selected": b(V)
                }, [
                  l("span", Ft, m(V.label), 1),
                  b(V) ? (o(), n("svg", Ot, [...y[3] || (y[3] = [
                    l("path", {
                      "stroke-linecap": "round",
                      "stroke-linejoin": "round",
                      "stroke-width": "2",
  ...
  key: 0,
  class: "text-error-500"
}, Kt = ["id", "accept", "multiple", "disabled", "required"], Ut = {
  key: 1,
  class: "mt-1.5 text-xs text-error-500"
}, Jt = {
  key: 2,
  ...
  setup(e, { emit: t }) {
    ...
    return (u, c) => (o(), n("div", {
      ...
      e.error ? (o(), n("p", Ut, m(e.error), 1)) : e.hint ? (o(), n("p", Jt, m(e.hint), 1)) : h("", !0)
    ], 2));
  }
}), Xt = ["disabled", "type"], Qt = {
  key: 0,
  ...
  setup(e, { emit: t }) {
    const r = e, s = t, a = {
      ...
      !r.disabled && !r.loading && s("click", c);
    };
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, n0 = { class: "flex-1" }, i0 = { class: "mb-1 text-sm font-semibold text-gray-800 dark:text-white/90" }, d0 = { class: "text-sm text-gray-500 dark:text-gray-400" }, aa = /* @__PURE__ */ L({
  inheritAttrs: !1,
  __name: "Alert",
  props: {
    variant: {},
  ...
  setup(e) {
    ...
    return (s, a) => {
      ...
      return o(), n("div", {
        ...
        l("div", r0, [
          l("div", {
            class: g(d(C)("-mt-0.5", r[e.variant].icon))
          }, [
          ...
          l("div", n0, [
            l("h4", i0, m(e.title), 1),
            l("p", d0, m(e.message), 1),
            e.showLink && e.linkHref ? (o(), S(i, {
              key: 0,
              to: e.linkHref,
          ...
          e.dismissible ? (o(), n("button", {
            key: 0,
            onClick: a[0] || (a[0] = (u) => s.$emit("dismiss")),
  ...
  key: 1,
  class: "ml-1"
}, g0 = "inline-flex items-center px-2.5 py-0.5 justify-center gap-1 rounded-full font-medium capitalize", na = /* @__PURE__ */ L({
  inheritAttrs: !1,
  __name: "Badge",
  props: {
  ...
  setup(e) {
    ...
    }, a = w(() => r[t.size]), i = w(() => s[t.variant][t.color]);
    return (u, c) => (o(), n("span", {
      class: g(d(C)(g0, a.value, i.value, t.class))
    }, [
  ...
  setup(e) {
    const t = {
      ...
      success: () => R("svg", { fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" }, [
        R("path", {
          "stroke-linecap": "round",
          "stroke-linejoin": "round",
          "stroke-width": "2",
      ...
      error: () => R("svg", { fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" }, [
        R("path", {
          "stroke-linecap": "round",
          "stroke-linejoin": "round",
          "stroke-width": "2",
      ...
      warning: () => R("svg", { fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" }, [
        R("path", {
          "stroke-linecap": "round",
          "stroke-linejoin": "round",
          "stroke-width": "2",
      ...
      info: () => R("svg", { fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" }, [
        R("path", {
          "stroke-linecap": "round",
          "stroke-linejoin": "round",
          "stroke-width": "2",
    ...
    return (c, f) => (o(), n("div", {
      ...
      l("div", f0, [
        (o(), S(G(u[e.type]), { class: "h-5 w-5" }))
      ]),
      l("div", b0, [
        l("p", h0, m(e.title), 1),
        e.message ? (o(), n("p", m0, m(e.message), 1)) : h("", !0)
      ]),
      e.dismissible ? (o(), n("button", {
        key: 0,
        type: "button",
        class: "flex-shrink-0 rounded-md p-1 hover:bg-black/10 dark:hover:bg-white/10 transition-colors",
        onClick: f[0] || (f[0] = (x) => c.$emit("dismiss"))
      }, [...f[1] || (f[1] = [
        l("svg", {
          class: "h-4 w-4",
          fill: "none",
...
function ge(e) {
  ...
  return ie.value.push(s), r > 0 && setTimeout(() => {
    Je(t);
  }, r), t;
}
function Je(e) {
...
function y0() {
  const e = (a) => ge({ ...a, type: "success" }), t = (a) => ge({ ...a, type: "error" }), r = (a) => ge({ ...a, type: "warning" }), s = (a) => ge({ ...a, type: "info" });
  return {
    toasts: t1(ie),
    success: e,
    error: t,
...
const ia = /* @__PURE__ */ L({
  ...
  setup(e) {
    ...
    return (a, i) => (o(), S(Ge, { to: "body" }, [
      l("div", {
        class: g(
          d(C)("fixed z-[99999] flex flex-col gap-2 p-4", s[e.position])
        )
      }, [
        O(r1, {
  ...
  setup(e, { emit: t }) {
    const r = e, s = t, a = w(() => ({
      ...
      const f = "fixed inset-0 h-full w-full", x = r.blur ? "backdrop-blur-[32px]" : "";
      return `${f} ${x} bg-black/60 dark:bg-black/70`;
    }), u = () => {
      r.closeOnBackdrop && (s("update:modelValue", !1), s("close"));
    }, c = (f) => {
      f.key === "Escape" && r.closeOnEscape && r.modelValue && (s("update:modelValue", !1), s("close"));
    };
    return be(
      () => r.modelValue,
      (f) => {
            ...
            O(ne, {
              ...
              default: Z(() => [
                e.modelValue ? (o(), n("div", {
                  ...
                  "aria-modal": "true",
                  tabindex: "-1",
                  class: g(d(C)("relative z-10 outline-none", a.value, r.class))
                }, [
                  M(f.$slots, "default")
                ], 2)) : h("", !0)
              ]),
  ...
  setup(e, { emit: t }) {
    const r = e, s = t, a = w({
      ...
      !r.loading && !r.confirmDisabled && s("confirm");
    }, c = () => {
      s("cancel"), s("close"), s("update:modelValue", !1);
    };
    return (f, x) => (o(), S(w0, {
      modelValue: a.value,
      ...
      default: Z(() => [
        l("div", $0, [
          l("div", V0, [
            l("h5", L0, m(e.title), 1),
            e.subtitle ? (o(), n("p", M0, m(e.subtitle), 1)) : h("", !0)
          ]),
          l("div", null, [
            M(f.$slots, "default")
          ]),
          l("div", H0, [
            ...
            l("button", {
              ...
              class: g(["flex w-full justify-center rounded-lg px-4 py-2.5 text-sm font-medium text-white sm:w-auto disabled:opacity-50", d(C)(i.value)])
            }, [
              e.loading ? (o(), n("svg", _0, [...x[1] || (x[1] = [
                l("circle", {
                  class: "opacity-25",
                  cx: "12",
                  cy: "12",
              ...
              D(" " + m(e.loading ? e.loadingText : e.confirmText), 1)
            ], 10, B0),
...
function D0(e = {}) {
  const { initialExpanded: t = !0, mobileBreakpoint: r = 1024 } = e, s = T(t), a = T(!1), i = T(!1), u = T(!1), c = T(null), f = T(null), x = () => {
    const _ = window.innerWidth < r;
    i.value = _, _ || (a.value = !1);
  };
  Y(() => {
  ...
  const b = () => {
    i.value ? a.value = !a.value : s.value = !s.value;
  }, p = () => {
    a.value = !a.value;
  }, v = () => {
    a.value = !1;
    ...
    f.value = f.value === _ ? null : _;
  }, B = {
    isExpanded: w(() => i.value ? !1 : s.value),
    isMobileOpen: a,
    isHovered: u,
    activeItem: c,
    openSubmenu: f,
    toggleSidebar: b,
    toggleMobileSidebar: p,
...
function ca(e = "theme", t = "light") {
  ...
  if ((s = window.matchMedia) != null && s.call(window, "(prefers-color-scheme: dark)").matches) {
    Q("dark");
    return;
  }
  Q(t);
...
function j0(e = {}) {
  const {
    ...
    syncWithSystem: s = !0
  } = e, a = T(r), i = T(!1), u = w(() => a.value === "dark"), c = () => {
  ...
  Y(() => {
    ...
    let p;
    b === "light" || b === "dark" ? p = b : s && ((v = window.matchMedia) != null && v.call(window, "(prefers-color-scheme: dark)").matches) ? p = "dark" : p = r, a.value = p, Q(p), i.value = !0, s && window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change", (y) => {
    ...
    p && (localStorage.setItem(t, b), Q(b));
  });
  const x = {
    theme: a,
    isDarkMode: u,
...
const E0 = /* @__PURE__ */ L({
  ...
  setup(e) {
    ...
    }), (r, s) => M(r.$slots, "default");
  }
}), G0 = /* @__PURE__ */ L({
  __name: "SidebarProvider",
  props: {
    initialExpanded: { type: Boolean, default: !0 },
    mobileBreakpoint: { default: 1024 }
  },
  setup(e) {
    const t = e;
    return D0({
...
}), q0 = { class: "flex flex-col overflow-y-auto duration-300 ease-linear no-scrollbar flex-1" }, P0 = { class: "mb-6" }, F0 = {
  key: 0,
  class: "mt-auto"
}, O0 = /* @__PURE__ */ L({
  __name: "Sidebar",
    ...
    return (b, p) => (o(), n("aside", {
      ...
      class: g(
        d(C)(
          ...
          d(r) || d(s) || d(a) ? "lg:w-[290px]" : "lg:w-[90px]",
          d(s) ? "translate-x-0 w-[290px]" : "-translate-x-full",
          "lg:translate-x-0"
        )
      ),
      onMouseenter: f,
      ...
      l("div", q0, [
        l("nav", P0, [
          M(b.$slots, "default", {
            ...
            isHovered: d(a),
            isMobileOpen: d(s),
            isCollapsed: !d(r) && !d(a) && !d(s)
          })
        ]),
        d(r) || d(a) || d(s) ? (o(), n("div", F0, [
          M(b.$slots, "footer", {
            isExpanded: d(r),
            isHovered: d(a),
            isMobileOpen: d(s)
...
}), R0 = { class: "sticky top-0 flex w-full bg-white border-gray-200 z-[9999] dark:border-gray-800 dark:bg-gray-900 lg:border-b" }, W0 = { class: "flex flex-col items-center justify-between grow lg:flex-row lg:px-6" }, N0 = { class: "flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-gray-200 dark:border-gray-800 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4" }, K0 = {
  key: 0,
  class: "fill-current",
  width: "24",
  height: "24",
  ...
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
}, J0 = ["aria-label", "aria-expanded"], X0 = { class: "hidden lg:block flex-1" }, Q0 = /* @__PURE__ */ L({
  __name: "Header",
  setup(e) {
    const { toggleSidebar: t, isMobileOpen: r } = J(), s = T(!1), a = () => {
      t();
    }, i = () => {
      s.value = !s.value;
    };
    return (u, c) => (o(), n("header", R0, [
      l("div", W0, [
        l("div", N0, [
          l("button", {
            type: "button",
            ...
            class: g(
              d(C)(
                ...
                d(r) ? "lg:bg-transparent dark:lg:bg-transparent bg-gray-100 dark:bg-gray-800" : ""
              )
            )
          }, [
            d(r) ? (o(), n("svg", K0, [...c[0] || (c[0] = [
              l("path", {
                "fill-rule": "evenodd",
                "clip-rule": "evenodd",
          ...
          l("button", {
            type: "button",
            onClick: i,
            "aria-label": s.value ? "Close menu" : "Open menu",
  ...
  __name: "Backdrop",
  setup(e) {
    const { toggleMobileSidebar: t, isMobileOpen: r } = J();
    return (s, a) => (o(), S(ne, {
...
}), er = { class: "min-h-screen xl:flex bg-gray-50 dark:bg-gray-950" }, tr = { class: "p-4 mx-auto max-w-screen-2xl md:p-6" }, ua = /* @__PURE__ */ L({
  __name: "AdminLayout",
  props: {
    defaultTheme: { default: "light" },
    storageKey: { default: "theme" },
  ...
  setup(e) {
    const { isExpanded: t, isHovered: r } = J();
    return (s, a) => (o(), S(E0, {
      "default-theme": e.defaultTheme,
      "storage-key": e.storageKey,
      "sync-with-system": e.syncWithSystem
    }, {
      default: Z(() => [
        O(G0, null, {
          default: Z(() => [
            l("div", er, [
              M(s.$slots, "sidebar", {}, () => [
                O(O0, null, {
                  logo: Z((i) => [
                    M(s.$slots, "sidebar-logo", pe(ye(i)))
                  ]),
                  default: Z((i) => [
                    M(s.$slots, "sidebar-nav", pe(ye(i)))
                  ]),
                  footer: Z((i) => [
                    M(s.$slots, "sidebar-footer", pe(ye(i)))
                  ]),
                  _: 3
                })
              ]),
              ...
              l("div", {
                ...
                M(s.$slots, "header", {}, () => [
                  O(Q0, null, {
                    logo: Z(() => [
                      M(s.$slots, "header-logo")
                    ]),
                    center: Z(() => [
                      M(s.$slots, "header-center")
                    ]),
                    actions: Z(() => [
                      M(s.$slots, "header-actions")
                    ]),
                    _: 3
                  })
                ]),
      ...
      _: 3
    }, 8, ["default-theme", "storage-key", "sync-with-system"]));
  }
}), rr = ["aria-label"], ga = /* @__PURE__ */ L({
  __name: "ThemeToggler",
  setup(e) {
    const { isDarkMode: t, toggleTheme: r } = A0();
    return (s, a) => (o(), n("button", {
      type: "button",
  ...
  setup(e) {
    const t = e, r = w(() => t.initials ? t.initials : t.name ? t.name.split(" ").map((u) => u[0]).join("").toUpperCase().slice(0, 2) : "?"), s = {
    ...
    return (u, c) => (o(), n("div", {
      class: g(
        d(C)("relative rounded-full flex-shrink-0", s[e.size], t.class)
      )
    }, [
      e.src ? (o(), n("img", {
        key: 0,
  ...
  key: 0,
  class: "px-6 py-5"
}, lr = { class: "text-base font-medium text-gray-800 dark:text-white/90" }, ar = {
  key: 0,
  class: "mt-1 text-sm text-gray-500 dark:text-gray-400"
}, nr = {
  key: 1,
  ...
  setup(e) {
    ...
    return (r, s) => (o(), n("div", {
      ...
      e.title || r.$slots.header ? (o(), n("div", sr, [
        M(r.$slots, "header", {}, () => [
          l("h3", lr, m(e.title), 1),
          e.description ? (o(), n("p", ar, m(e.description), 1)) : h("", !0)
        ])
      ])) : h("", !0),
      l("div", {
        class: g(
...
const ir = { class: "p-4 flex flex-col items-center" }, dr = { class: "text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2" }, cr = { class: "relative w-40 h-24" }, ur = {
  ...
  setup(e) {
    ...
    ), a = w(() => t.value === null || t.max <= 0 ? 0 : Math.min(100, Math.max(0, t.value / t.max * 100))), i = w(() => t.value === null ? "--" : t.value.toLocaleString(t.locale)), u = w(() => t.adaptive ? Ye(a.value, t.color, t.thresholds) : t.color), c = w(() => re[u.value]), f = Math.PI * yr, x = w(
      () => f - a.value / 100 * f
    );
    return (b, p) => (o(), S(te, {
      class: g(
      ...
      default: Z(() => [
        l("div", ir, [
          l("span", dr, m(e.label), 1),
          l("div", cr, [
            (o(), n("svg", ur, [
              l("path", {
                d: "M 10 80 A 70 70 0 0 1 150 80",
                fill: "none",
                class: g(d(C)(c.value.trackLight, c.value.trackDark)),
                "stroke-width": ze,
                "stroke-linecap": "round"
              }, null, 2),
              l("path", {
                d: "M 10 80 A 70 70 0 0 1 150 80",
                fill: "none",
                class: g(d(C)(c.value.bar, "transition-all duration-700 ease-out")),
                "stroke-width": ze,
                "stroke-linecap": "round",
                "stroke-dasharray": f,
            ...
            l("div", fr, [
              l("div", br, [
                ...
                l("span", hr, m(e.unit), 1)
              ])
            ])
          ]),
          e.subtitle ? (o(), n("span", mr, m(e.subtitle), 1)) : h("", !0)
        ]),
        s.value ? (o(), n("div", Cr, [
          l("div", xr, [
            M(b.$slots, "details", {}, () => [
              (o(!0), n(A, null, E(e.details, (v, y) => (o(), n("div", {
                key: y,
                class: "flex items-center justify-between"
              }, [
                l("span", vr, m(v.label), 1),
                l("span", pr, m(v.value), 1)
              ]))), 128))
            ])
          ])
        ])) : h("", !0)
...
}), kr = { class: "flex items-center justify-between px-5 pt-5" }, wr = { class: "text-sm font-medium text-gray-500 dark:text-gray-400" }, $r = { class: "flex items-baseline gap-1" }, Vr = { class: "text-sm text-gray-400 dark:text-gray-500" }, Lr = {
  key: 0,
  class: "flex items-center justify-between mb-2"
}, Mr = { class: "text-sm font-medium text-gray-500 dark:text-gray-400" }, Hr = { class: "flex items-baseline gap-1" }, Br = { class: "text-xs text-gray-400 dark:text-gray-500" }, _r = {
  key: 0,
  class: "absolute inset-0 flex items-center justify-center"
}, Zr = { class: "text-xs font-semibold text-white mix-blend-difference" }, Sr = {
  key: 0,
  ...
  setup(e) {
    const t = e, r = w(() => t.value === null || t.max <= 0 ? 0 : Math.min(100, Math.max(0, t.value / t.max * 100))), s = w(() => Math.round(t.value ?? 0)), a = w(() => t.adaptive ? Ye(r.value, t.color, t.thresholds) : t.color), i = w(() => re[a.value]), u = w(() => {
      const c = [];
      for (let f = 0; f <= t.scaleDivisions; f++)
        c.push(Math.round(t.max / t.scaleDivisions * f));
      return c;
    });
    return (c, f) => (o(), S(G(e.wrapped ? te : "div"), {
      class: g(t.class),
      "content-class": "!space-y-3"
    }, s1({
      default: Z(() => [
        e.wrapped ? h("", !0) : (o(), n("div", Lr, [
          l("span", Mr, m(e.label), 1),
          l("div", Hr, [
            l("span", {
              class: g(
                d(C)(
            ...
            }, m(e.value !== null ? s.value : "--"), 3),
            l("span", Br, m(e.unit), 1)
          ])
        ])),
        l("div", {
          ...
          l("div", {
            ...
            l("div", {
              ...
              style: U({ width: `${r.value}%` })
            }, null, 6),
            e.showInnerLabel ? (o(), n("div", _r, [
              l("span", Zr, m(s.value) + " " + m(e.unit), 1)
            ])) : h("", !0)
          ], 2),
          e.showScale ? (o(), n("div", Sr, [
            (o(!0), n(A, null, E(u.value, (x) => (o(), n("span", { key: x }, m(x) + m(e.unit), 1))), 128))
          ])) : h("", !0)
        ], 2)
      ]),
      _: 2
      ...
      default: Z(() => [
        l("div", Ir, [
          ...
          l("div", Dr, [
            ...
            e.unit ? (o(), n("span", jr, m(e.unit), 1)) : h("", !0)
          ]),
          e.subtitle ? (o(), n("div", {
            key: 0,
            class: g(
...
}), Ar = { class: "flex items-center justify-between" }, Er = { class: "text-sm text-gray-500 dark:text-gray-400" }, Gr = { class: "mt-1.5 w-full h-1.5 bg-gray-200 dark:bg-gray-800 rounded-full overflow-hidden" }, qr = {
  key: 0,
...
}, Rr = { class: "w-full flex-1 relative" }, Wr = {
  key: 2,
  ...
  setup(e) {
    const t = e, r = fe(), s = w(() => re[t.color]), a = w(() => t.items.length === 0 ? 1 : Math.max(...t.items.map((b) => b.value), 1));
    function i(b) {
      return b > 999 ? (b / 1e3).toFixed(1) : String(b);
    }
    function u(b) {
      return t.formatValue ? t.formatValue(b) : i(b);
    }
    function c(b) {
      return b <= 0 ? "0%" : `${Math.max(t.minBarPercent, b / a.value * 100)}%`;
    }
    function f(b) {
      const p = s.value.hex;
      if (b >= 100) return p;
      const v = Math.round(b / 100 * 255).toString(16).padStart(2, "0");
      return `${p}${v}`;
    }
    const x = w(() => {
      if (!t.showGroupBoundary) return /* @__PURE__ */ new Set();
      const b = /* @__PURE__ */ new Set();
      for (let p = 1; p < t.items.length; p++)
        t.items[p].group !== void 0 && t.items[p - 1].group !== void 0 && t.items[p].group !== t.items[p - 1].group && b.add(p);
      return b;
    });
    return (b, p) => (o(), S(te, {
      class: g(
            ...
            (o(!0), n(A, null, E(e.items, (v, y) => {
              ...
              return o(), n("div", {
                ...
                class: g([
                  ...
                  d(C)(
                    x.value.has(y) ? "border-l border-gray-300 dark:border-gray-700 pl-0.5" : ""
                  )
                ])
              }, [
                e.showValues && v.value > 0 ? (o(), n("span", Or, m(u(v.value)), 1)) : h("", !0),
                l("div", Rr, [
                  l("div", {
                    class: "absolute bottom-0 left-0.5 right-0.5 rounded-t transition-all duration-500",
                    style: U({
                      height: c(v.value),
                      backgroundColor: v.highlighted ? f(100) : v.group === ((V = e.items[e.items.length - 1]) == null ? void 0 : V.group) ? f(50) : f(25)
                    })
                  }, null, 4)
                ]),
                l("span", {
                  ...
                  style: U({
                    color: v.highlighted ? s.value.hex : void 0,
                    fontWeight: v.highlighted ? "500" : void 0,
                    opacity: v.group !== ((H = e.items[e.items.length - 1]) == null ? void 0 : H.group) && !v.highlighted ? "0.4" : void 0
                  })
                }, m(v.label), 5)
              ], 2);
            }), 128))
          ], 4)) : (o(), n("div", Wr, m(e.emptyLabel), 1))
        ])
      ]),
      _: 3
    }, 8, ["class"]));
        ...
        l("div", Nr, [
          ...
          l("div", Ur, [
            (o(!0), n(A, null, E(e.rows, (u, c) => (o(), n("div", {
              ...
              l("span", Jr, m(u.label), 1),
              l("span", {
                class: g(
                  d(C)(
                    "text-sm font-medium tabular-nums",
                    u.accent ? `${s.value.textLight} ${s.value.textDark}` : "text-gray-700 dark:text-gray-300"
                  )
                )
              }, m(u.value), 3)
            ], 2))), 128))
          ]),
          d(r).footer ? (o(), n("div", Xr, [
            M(a.$slots, "footer")
          ])) : h("", !0)
        ])
      ]),
...
}), Qr = { class: "text-xl font-semibold text-gray-800 dark:text-white/90" }, Yr = { "aria-label": "Breadcrumb" }, e5 = { class: "flex items-center gap-1.5" }, t5 = {
  key: 2,
  ...
  setup(e) {
    ...
    return (r, s) => (o(), n("div", {
      class: g(
        d(C)("flex flex-wrap items-center justify-between gap-3 mb-6", t.class)
      )
    }, [
      l("h2", Qr, m(e.pageTitle), 1),
      l("nav", Yr, [
        l("ol", e5, [
          (o(!0), n(A, null, E(e.items, (a, i) => (o(), n("li", {
            ...
            a.href && i < e.items.length - 1 ? (o(), S(G(e.linkComponent), {
              key: 0,
              href: a.href,
              to: a.to,
            ...
            i < e.items.length - 1 ? (o(), n("svg", t5, [...s[0] || (s[0] = [
              l("path", {
...
function r5(e, t) {
  const r = (s) => {
    e.value && !e.value.contains(s.target) && t(s);
  };
  Y(() => {
...
const o5 = ["aria-expanded"], s5 = ["onClick"], ya = /* @__PURE__ */ L({
  inheritAttrs: !1,
  __name: "DropdownMenu",
  props: {
    items: { default: () => [] },
  ...
  emits: ["select"],
  setup(e, { emit: t }) {
    const r = e, s = t, a = T(!1), i = T(null), u = () => {
      a.value = !a.value;
    }, c = () => {
      a.value = !1;
    }, f = (b) => {
      b.disabled || (b.onClick && b.onClick(), s("select", b), c());
    }, x = (b) => {
      b.key === "Escape" && a.value && c();
    };
    return Y(() => document.addEventListener("keydown", x)), he(() => document.removeEventListener("keydown", x)), r5(i, c), (b, p) => (o(), n("div", {
      class: g(d(C)("relative", r.class)),
      ref_key: "dropdownRef",
      ref: i
    }, [
      l("button", {
      ...
      O(ne, {
        ...
        default: Z(() => [
          a.value ? (o(), n("div", {
            key: 0,
            role: "menu",
            class: g(d(C)(e.menuClass))
          }, [
            M(b.$slots, "menu", { close: c }, () => [
              (o(!0), n(A, null, E(e.items, (v, y) => (o(), n("button", {
                key: y,
                type: "button",
                onClick: (V) => f(v),
                role: "menuitem",
                class: g(d(C)(e.itemClass))
              }, [
                v.icon ? (o(), S(G(v.icon), {
                  key: 0,
                  class: "w-4 h-4"
  ...
  setup(e) {
    const t = e, { isExpanded: r, isMobileOpen: s, isHovered: a, setActiveItem: i } = J();
    let u = null;
    try {
      u = Fe();
    } catch {
    ...
    const c = w(() => t.active !== void 0 ? t.active : u && t.to ? u.path === t.to || u.path.startsWith(t.to + "/") : !1), f = w(
      () => C(
        ...
        !r.value && !s.value && !a.value && "lg:justify-center",
        t.class
      )
    ), x = w(
      () => C(
    ...
    return (p, v) => {
      ...
      return e.to ? (o(), S(y, {
        ...
        default: Z(() => [
          ...
          d(r) || d(s) || d(a) ? (o(), n("span", l5, [
            D(m(e.label) + " ", 1),
            e.badge ? (o(), n("span", a5, m(e.badge), 1)) : h("", !0)
          ])) : h("", !0)
        ]),
        _: 1
        ...
        d(r) || d(s) || d(a) ? (o(), n("span", n5, [
          D(m(e.label) + " ", 1),
          e.badge ? (o(), n("span", i5, m(e.badge), 1)) : h("", !0)
        ])) : h("", !0)
      ], 2));
    };
  }
...
}, c5 = { class: "flex flex-col gap-0.5" }, wa = /* @__PURE__ */ L({
  inheritAttrs: !1,
  __name: "SidebarGroup",
  props: {
    title: {},
  ...
  setup(e) {
    const t = e, { isExpanded: r, isMobileOpen: s, isHovered: a } = J();
    return (i, u) => (o(), n("div", {
      class: g(d(C)("mb-6", t.class))
    }, [
      e.title && (d(r) || d(s) || d(a)) ? (o(), n("div", d5, m(e.title), 1)) : h("", !0),
      l("ul", c5, [
        M(i.$slots, "default")
      ])
    ], 2));
  ...
  setup(e) {
    const t = e, { isExpanded: r, isMobileOpen: s, isHovered: a, openSubmenu: i, toggleSubmenu: u } = J(), c = w(() => i.value === t.name), f = () => u(t.name);
    return (x, b) => (o(), n("div", {
      class: g(d(C)(t.class))
    }, [
      l("button", {
        ...
        d(r) || d(s) || d(a) ? (o(), n("span", u5, [
          l("span", null, m(e.label), 1),
          (o(), n("svg", {
            class: g(
              d(C)(
      ...
      c.value && (d(r) || d(s) || d(a)) ? (o(), n("div", g5, [
        M(x.$slots, "default")
      ])) : h("", !0)
    ], 2));
  }
...
const m5 = /* @__PURE__ */ k(f5, [["render", h5]]), C5 = {}, x5 = {
  class: "w-5 h-5",
  viewBox: "0 0 20 20",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
...
const p5 = /* @__PURE__ */ k(C5, [["render", v5]]), y5 = {}, k5 = {
  class: "w-5 h-5",
  viewBox: "0 0 20 20",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
...
const $5 = /* @__PURE__ */ k(y5, [["render", w5]]), V5 = {}, L5 = {
  class: "w-5 h-5",
  viewBox: "0 0 24 24",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
...
const H5 = /* @__PURE__ */ k(V5, [["render", M5]]), B5 = {}, _5 = {
  class: "w-5 h-5",
  viewBox: "0 0 20 20",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
...
const S5 = /* @__PURE__ */ k(B5, [["render", Z5]]), I5 = {}, z5 = {
  class: "w-5 h-5",
  viewBox: "0 0 16 16",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
...
const D5 = /* @__PURE__ */ k(I5, [["render", T5]]), j5 = {}, A5 = {
  class: "w-5 h-5",
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
  fill: "none"
...
const Te = /* @__PURE__ */ k(j5, [["render", E5]]), G5 = {}, q5 = {
  class: "w-5 h-5",
  viewBox: "0 0 24 24",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
...
const F5 = /* @__PURE__ */ k(G5, [["render", P5]]), O5 = {}, R5 = {
  class: "w-5 h-5",
  viewBox: "0 0 14 14",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
...
const N5 = /* @__PURE__ */ k(O5, [["render", W5]]), K5 = {}, U5 = {
  class: "w-5 h-5",
  viewBox: "0 0 20 20",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
...
const X5 = /* @__PURE__ */ k(K5, [["render", J5]]), Q5 = {}, Y5 = {
  class: "w-5 h-5",
  viewBox: "0 0 16 16",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
...
const to = /* @__PURE__ */ k(Q5, [["render", eo]]), ro = {}, oo = {
  class: "w-5 h-5",
  viewBox: "0 0 24 24",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
...
const lo = /* @__PURE__ */ k(ro, [["render", so]]), ao = {}, no = {
  class: "w-5 h-5",
  viewBox: "0 0 20 20",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
...
const co = /* @__PURE__ */ k(ao, [["render", io]]), uo = {}, go = {
  class: "w-5 h-5",
  viewBox: "0 0 24 24",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
...
const bo = /* @__PURE__ */ k(uo, [["render", fo]]), ho = {}, mo = {
  class: "w-5 h-5",
  viewBox: "0 0 24 24",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
...
const xo = /* @__PURE__ */ k(ho, [["render", Co]]), vo = {}, po = {
  class: "w-5 h-5",
  viewBox: "0 0 20 20",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
...
const ko = /* @__PURE__ */ k(vo, [["render", yo]]), wo = {}, $o = {
  class: "w-5 h-5",
  viewBox: "0 0 24 24",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
...
const Lo = /* @__PURE__ */ k(wo, [["render", Vo]]), Mo = {}, Ho = {
  class: "w-5 h-5",
  viewBox: "0 0 24 24",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
...
const _o = /* @__PURE__ */ k(Mo, [["render", Bo]]), Zo = {}, So = {
  class: "w-5 h-5",
  viewBox: "0 0 16 16",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
...
const zo = /* @__PURE__ */ k(Zo, [["render", Io]]), To = {}, Do = {
  class: "w-5 h-5",
  viewBox: "0 0 24 24",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
...
const Ao = /* @__PURE__ */ k(To, [["render", jo]]), Eo = {}, Go = {
  class: "w-5 h-5",
  viewBox: "0 0 24 24",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
...
const Po = /* @__PURE__ */ k(Eo, [["render", qo]]), Fo = {}, Oo = {
  class: "w-5 h-5",
  viewBox: "0 0 24 24",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
...
const Wo = /* @__PURE__ */ k(Fo, [["render", Ro]]), No = {}, Ko = {
  class: "w-5 h-5",
  viewBox: "0 0 20 20",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
...
const Jo = /* @__PURE__ */ k(No, [["render", Uo]]), Xo = {}, Qo = {
  class: "w-5 h-5",
  viewBox: "0 0 24 24",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
...
const es = /* @__PURE__ */ k(Xo, [["render", Yo]]), ts = {}, rs = {
  class: "w-5 h-5",
  viewBox: "0 0 24 24",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
...
const ss = /* @__PURE__ */ k(ts, [["render", os]]), ls = {}, as = {
  class: "w-5 h-5",
  viewBox: "0 0 20 20",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
...
const is = /* @__PURE__ */ k(ls, [["render", ns]]), ds = {}, cs = {
  class: "w-5 h-5",
  viewBox: "0 0 24 24",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
...
const gs = /* @__PURE__ */ k(ds, [["render", us]]), fs = {}, bs = {
  class: "w-5 h-5",
  viewBox: "0 0 20 20",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
...
const ms = /* @__PURE__ */ k(fs, [["render", hs]]), Cs = {}, xs = {
  class: "w-5 h-5",
  viewBox: "0 0 18 18",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
...
const ps = /* @__PURE__ */ k(Cs, [["render", vs]]), ys = {}, ks = {
  class: "w-5 h-5",
  viewBox: "0 0 24 24",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
...
const $s = /* @__PURE__ */ k(ys, [["render", ws]]), Vs = {}, Ls = {
  class: "w-5 h-5",
  viewBox: "0 0 16 16",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
...
const Hs = /* @__PURE__ */ k(Vs, [["render", Ms]]), Bs = {}, _s = {
  class: "w-5 h-5",
  viewBox: "0 0 24 24",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
...
const Ss = /* @__PURE__ */ k(Bs, [["render", Zs]]), Is = {}, zs = {
  class: "w-5 h-5",
  viewBox: "0 0 24 24",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
...
const Ds = /* @__PURE__ */ k(Is, [["render", Ts]]), js = {}, As = {
  class: "w-5 h-5",
  viewBox: "0 0 12 12",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
...
const Gs = /* @__PURE__ */ k(js, [["render", Es]]), qs = {}, Ps = {
  class: "w-5 h-5",
  viewBox: "0 0 20 20",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
...
const Os = /* @__PURE__ */ k(qs, [["render", Fs]]), Rs = {}, Ws = {
  class: "w-5 h-5",
  viewBox: "0 0 20 20",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
...
const Ks = /* @__PURE__ */ k(Rs, [["render", Ns]]), Us = {}, Js = {
  class: "w-5 h-5",
  viewBox: "0 0 24 24",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
...
const Qs = /* @__PURE__ */ k(Us, [["render", Xs]]), Ys = {}, el = {
  class: "w-5 h-5",
  viewBox: "0 0 20 20",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
...
const De = /* @__PURE__ */ k(Ys, [["render", tl]]), rl = {}, ol = {
  class: "w-5 h-5",
  viewBox: "0 0 24 24",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
...
const ll = /* @__PURE__ */ k(rl, [["render", sl]]), al = {}, nl = {
  class: "w-5 h-5",
  viewBox: "0 0 24 24",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
...
const dl = /* @__PURE__ */ k(al, [["render", il]]), cl = {}, ul = {
  class: "w-5 h-5",
  viewBox: "0 0 24 24",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
...
const fl = /* @__PURE__ */ k(cl, [["render", gl]]), bl = {}, hl = {
  class: "w-5 h-5",
  viewBox: "0 0 24 24",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
...
const Cl = /* @__PURE__ */ k(bl, [["render", ml]]), xl = {}, vl = {
  class: "w-5 h-5",
  viewBox: "0 0 20 20",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
...
const yl = /* @__PURE__ */ k(xl, [["render", pl]]), kl = {}, wl = {
  class: "w-5 h-5",
  viewBox: "0 0 24 24",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
...
const Vl = /* @__PURE__ */ k(kl, [["render", $l]]), Ll = {}, Ml = {
  class: "w-5 h-5",
  viewBox: "0 0 24 24",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
...
const Bl = /* @__PURE__ */ k(Ll, [["render", Hl]]), _l = {}, Zl = {
  class: "w-5 h-5",
  viewBox: "0 0 20 20",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
...
const Il = /* @__PURE__ */ k(_l, [["render", Sl]]), zl = {}, Tl = {
  class: "w-5 h-5",
  viewBox: "0 0 24 24",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
...
const jl = /* @__PURE__ */ k(zl, [["render", Dl]]), je = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  ArchiveIcon: m5,
  BarChartIcon: p5,
  BellIcon: $5,
  ...
  UserGroupIcon: Il,
  WarningIcon: jl
}, Symbol.toStringTag, { value: "Module" })), Al = { class: "icon-gallery" }, El = {
  key: 0,
  class: "icon-gallery-search"
}, Gl = { class: "icon-gallery-count" }, ql = ["onClick", "title", "onKeydown"], Pl = { class: "icon-gallery-name" }, Fl = {
  key: 0,
  ...
  setup(e) {
    const t = e, r = T(""), s = T(null), a = w(() => {
      const x = Object.keys(je).filter(
        (b) => b.endsWith("Icon") || b === "HorizontalDots"
      );
      return t.filter && t.filter.length > 0 ? x.filter((b) => t.filter.includes(b)) : x;
    }), i = w(() => {
      if (!r.value) return a.value;
      const x = r.value.toLowerCase();
      return a.value.filter((b) => b.toLowerCase().includes(x));
    }), u = (x) => je[x], c = async (x) => {
      const b = `import { ${x} } from '@four-bytes/four-tailwind-ui'`;
      try {
        await navigator.clipboard.writeText(b), s.value = x, setTimeout(() => {
          s.value = null;
        }, 2e3);
      } catch (p) {
    ...
    return (x, b) => (o(), n("div", Al, [
      e.searchable ? (o(), n("div", El, [
        l1(l("input", {
        ...
        l("span", Gl, m(i.value.length) + " icons", 1)
      ])) : h("", !0),
      l("div", {
        class: "icon-gallery-grid",
        style: U(f.value)
      }, [
        (o(!0), n(A, null, E(i.value, (p) => (o(), n("div", {
          key: p,
          class: g(["icon-gallery-card", { "icon-gallery-card--copied": s.value === p }]),
          onClick: (v) => c(p),
          title: `Click to copy import for ${p}`,
          role: "button",
          tabindex: "0",
          onKeydown: n1((v) => c(p), ["enter"])
        }, [
          l("div", {
            class: "icon-gallery-preview",
            style: U({ width: `${e.iconSize}px`, height: `${e.iconSize}px` })
          }, [
            (o(), S(G(u(p))))
          ], 4),
          l("span", Pl, m(p), 1),
          s.value === p ? (o(), n("span", Fl, "Copied!")) : h("", !0)
        ], 42, ql))), 128))
      ], 4),
      i.value.length === 0 ? (o(), n("div", Ol, ' No icons found for "' + m(r.value) + '" ', 1)) : h("", !0)
    ]));
  }
}), Va = /* @__PURE__ */ k(Rl, [["__scopeId", "data-v-fe5652c1"]]), La = {
  mounted(e, t) {
...
export {
  ...
  N5 as CheckIcon,
  Yl as CheckboxField,
  X5 as ChevronDownIcon,
  to as ChevronRightIcon,
  da as ConfirmDialog,
  ea as DatePickerField,
  lo as DocsIcon,
  co as DraftIcon,
  ya as DropdownMenu,
  Jl as EmailField,
  ...
  Q0 as Header,
  zo as HomeIcon,
  Ao as HorizontalDots,
  Va as IconGallery,
  Po as InfoCircleIcon,
  Wo as InfoIcon,
  Kl as InputField,
  Ul as InputGroup,
  va as KeyValueList,
  Jo as LayoutDashboardIcon,
  es as ListIcon,
  ss as LogoutIcon,
  is as MailBox,
  gs as MailIcon,
  ...
  Qe as ThemeSymbol,
  ga as ThemeToggler,
  ta as TimePickerField,
  C0 as Toast,
  ia as ToastContainer,
  ra as ToggleSwitch,
  yl as TrashIcon,
  Vl as TrashIconLg,
  Bl as UserCircleIcon,
  Il as UserGroupIcon,
  jl as WarningIcon,
  ca as autoInitTheme,
  La as clickOutside,
  ...
  r5 as useClickOutside,
  J as useSidebar,
  D0 as useSidebarProvider,
  A0 as useTheme,
  j0 as useThemeProvider,
  y0 as useToast,
  La as vClickOutside
};
