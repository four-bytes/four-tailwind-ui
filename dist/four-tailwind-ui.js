import { defineComponent as L, useId as q, computed as w, openBlock as o, createElementBlock as n, normalizeClass as g, unref as d, createTextVNode as D, toDisplayString as C, createCommentVNode as b, createElementVNode as l, useSlots as fe, renderSlot as M, ref as T, watch as be, Fragment as A, renderList as E, onMounted as Y, onBeforeUnmount as e1, withModifiers as Ae, createVNode as O, Transition as ne, withCtx as _, createBlock as Z, resolveDynamicComponent as G, resolveComponent as Ee, h as R, readonly as t1, Teleport as Ge, TransitionGroup as r1, nextTick as o1, onUnmounted as he, inject as qe, provide as Pe, normalizeProps as pe, guardReactiveProps as ye, createSlots as s1, normalizeStyle as Q, withDirectives as l1, vModelText as a1, withKeys as n1 } from "vue";
...
const $e = "-", d1 = (e) => {
  ...
  const {
    ...
    const p = f.length === 0 ? c : c.substring(x), y = p.startsWith(Ne), V = y ? p.substring(1) : p, I = v && v > x ? v - x : void 0;
    return {
      modifiers: f,
  ...
  for (let f = u.length - 1; f >= 0; f -= 1) {
    ...
    let V = !!y, I = s(V ? p.substring(0, y) : p);
    if (!I) {
      if (!V) {
        c = h + (c.length > 0 ? " " + c : c);
        continue;
    ...
    const H = m1(x).join(":"), B = v ? H + Ne : H, j = B + I;
    if (i.includes(j))
      continue;
    i.push(j);
    const oe = a(I, V);
...
function y1(e, ...t) {
  ...
  function u(f) {
    ...
    return r = C1(h), s = r.cache.get, a = r.cache.set, i = c, c(f);
  }
  function c(f) {
    const h = s(f);
    if (h)
...
const S = (e) => {
...
}, Ke = /^\[(?:([a-z-]+):)?(.+)\]$/i, k1 = /^\d+\/\d+$/, w1 = /* @__PURE__ */ new Set(["px", "full", "screen"]), $1 = /^(\d+(\.\d+)?)?(xs|sm|md|lg|xl)$/, V1 = /\d+(%|px|r?em|[sdl]?v([hwib]|min|max)|pt|pc|in|cm|mm|cap|ch|ex|r?lh|cq(w|h|i|b|min|max))|\b(calc|min|max|clamp)\(.+\)|^0$/, L1 = /^(rgba?|hsla?|hwb|(ok)?(lab|lch)|color-mix)\(.+\)$/, M1 = /^(inset_)?-?((\d+)?\.?(\d+)[a-z]+|0)_-?((\d+)?\.?(\d+)[a-z]+|0)/, H1 = /^(url|image|image-set|cross-fade|element|(repeating-)?(linear|radial|conic)-gradient)\(.+\)$/, F = (e) => J(e) || w1.has(e) || k1.test(e), N = (e) => ee(e, "length", D1), J = (e) => !!e && !Number.isNaN(Number(e)), ke = (e) => ee(e, "number", J), le = (e) => !!e && Number.isInteger(Number(e)), B1 = (e) => e.endsWith("%") && J(e.slice(0, -1)), $ = (e) => Ke.test(e), W = (e) => $1.test(e), _1 = /* @__PURE__ */ new Set(["length", "size", "percentage"]), Z1 = (e) => ee(e, _1, Ue), S1 = (e) => ee(e, "position", Ue), I1 = /* @__PURE__ */ new Set(["image", "url"]), z1 = (e) => ee(e, I1, A1), T1 = (e) => ee(e, "", j1), ae = () => !0, ee = (e, t, r) => {
  const s = Ke.exec(e);
  ...
  const e = S("colors"), t = S("spacing"), r = S("blur"), s = S("brightness"), a = S("borderColor"), i = S("borderRadius"), u = S("borderSpacing"), c = S("borderWidth"), f = S("contrast"), h = S("grayscale"), x = S("hueRotate"), v = S("invert"), p = S("gap"), y = S("gradientColorStops"), V = S("gradientColorStopPositions"), I = S("inset"), H = S("margin"), B = S("opacity"), j = S("padding"), oe = S("saturate"), K = S("scale"), de = S("sepia"), Ve = S("skew"), Le = S("space"), Me = S("translate"), me = () => ["auto", "contain", "none"], Ce = () => ["auto", "hidden", "clip", "visible", "scroll"], xe = () => ["auto", $, t], z = () => [$, t], He = () => ["", F, N], ce = () => ["auto", J, $], Be = () => ["bottom", "center", "left", "left-bottom", "left-top", "right", "right-bottom", "right-top", "top"], ue = () => ["solid", "dashed", "dotted", "double", "none"], _e = () => ["normal", "multiply", "screen", "overlay", "darken", "lighten", "color-dodge", "color-burn", "hard-light", "soft-light", "difference", "exclusion", "hue", "saturation", "color", "luminosity"], ve = () => ["start", "end", "center", "between", "around", "evenly", "stretch"], se = () => ["", "0", $], Ze = () => ["auto", "avoid", "all", "avoid-page", "page", "left", "right", "column"], P = () => [J, $];
  return {
    cacheSize: 500,
    separator: ":",
    theme: {
      ...
      gradientColorStopPositions: [B1, N],
      inset: xe(),
      margin: xe(),
      opacity: P(),
      padding: z(),
...
const q1 = ["for"], P1 = {
...
}, W1 = ["id"], K1 = ["id"], U1 = ["id"], Kl = /* @__PURE__ */ L({
  inheritAttrs: !1,
  __name: "InputField",
  props: {
    modelValue: {},
  ...
  setup(e) {
    ...
    return (r, s) => (o(), n("label", {
      ...
      e.label ? (o(), n("span", Tt, C(e.label), 1)) : b("", !0)
    ], 2));
  }
}), Dt = {
  key: 0,
  ...
  setup(e, { emit: t }) {
    const r = e, s = t, a = T(!1), i = T(null), u = w(() => r.modelValue), c = () => {
      ...
      let V;
      y === -1 ? V = [...u.value, p] : V = u.value.filter((I, H) => H !== y), s("update:modelValue", V);
    }, h = (p) => {
        ...
        l("div", {
          ...
          l("div", At, [
            (o(!0), n(A, null, E(u.value, (V) => (o(), n("div", {
              ...
              l("span", null, C(V.label), 1),
              e.disabled ? b("", !0) : (o(), n("button", {
                key: 0,
                onClick: Ae((I) => h(V), ["stop"]),
  ...
  setup(e, { emit: t }) {
    ...
    return (u, c) => (o(), n("div", {
      ...
      e.error ? (o(), n("p", Ut, C(e.error), 1)) : e.hint ? (o(), n("p", Jt, C(e.hint), 1)) : b("", !0)
    ], 2));
  }
}), Xt = ["disabled", "type"], Qt = {
  key: 0,
...
const ia = /* @__PURE__ */ L({
  ...
  setup(e) {
    ...
    return (a, i) => (o(), Z(Ge, { to: "body" }, [
      l("div", {
        class: g(
          d(m)("fixed z-[99999] flex flex-col gap-2 p-4", s[e.position])
        )
      }, [
        O(r1, {
        ...
        l("div", $0, [
          ...
          l("div", H0, [
            ...
            l("button", {
              ...
              D(" " + C(e.loading ? e.loadingText : e.confirmText), 1)
            ], 10, B0),
...
function D0(e = {}) {
  const { initialExpanded: t = !0, mobileBreakpoint: r = 1024 } = e, s = T(t), a = T(!1), i = T(!1), u = T(!1), c = T(null), f = T(null), h = () => {
...
function j0(e = {}) {
  ...
  Y(() => {
    ...
    let v;
    x === "light" || x === "dark" ? v = x : s && ((p = window.matchMedia) != null && p.call(window, "(prefers-color-scheme: dark)").matches) ? v = "dark" : v = r, a.value = v, X(v), i.value = !0, s && window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change", (y) => {
...
const E0 = /* @__PURE__ */ L({
...
}), R0 = { class: "sticky top-0 flex w-full bg-white border-gray-200 z-[9999] dark:border-gray-800 dark:bg-gray-900 lg:border-b" }, N0 = { class: "flex flex-col items-center justify-between grow lg:flex-row lg:px-6" }, W0 = { class: "flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-gray-200 dark:border-gray-800 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4" }, K0 = {
  key: 0,
  class: "fill-current",
  width: "24",
  height: "24",
  ...
  __name: "Header",
  setup(e) {
    const { toggleSidebar: t, isMobileOpen: r } = U(), s = T(!1), a = () => {
      t();
    }, i = () => {
      s.value = !s.value;
    };
  ...
  __name: "Backdrop",
  setup(e) {
    const { toggleMobileSidebar: t, isMobileOpen: r } = U();
    return (s, a) => (o(), Z(ne, {
  ...
  setup(e) {
    const { isExpanded: t, isHovered: r } = U();
    return (s, a) => (o(), Z(E0, {
  ...
  setup(e) {
    ...
    return (u, c) => (o(), n("div", {
      class: g(
        d(m)("relative rounded-full flex-shrink-0", s[e.size], t.class)
      )
    }, [
      e.src ? (o(), n("img", {
        key: 0,
  ...
  setup(e) {
    ...
    return (r, s) => (o(), n("div", {
      ...
      e.title || r.$slots.header ? (o(), n("div", sr, [
        M(r.$slots, "header", {}, () => [
          l("h3", lr, C(e.title), 1),
          e.description ? (o(), n("p", ar, C(e.description), 1)) : b("", !0)
        ])
      ])) : b("", !0),
      l("div", {
        class: g(
...
const ir = { class: "relative p-4 flex flex-col items-center" }, dr = { class: "text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2" }, cr = { class: "relative w-40 h-24" }, ur = {
  ...
  setup(e) {
    ...
    ), a = w(() => t.value === null || t.max <= 0 ? 0 : Math.min(100, Math.max(0, t.value / t.max * 100))), i = w(() => t.value === null ? "--" : t.value.toLocaleString(t.locale)), u = w(() => t.adaptive ? Ye(a.value, t.color, t.thresholds) : t.color), c = w(() => re[u.value]), f = Math.PI * yr, h = w(
      () => f - a.value / 100 * f
    );
    return (x, v) => (o(), Z(te, {
      class: g(
          ...
          l("div", cr, [
            ...
            l("div", fr, [
              l("div", br, [
                ...
                l("span", hr, C(e.unit), 1)
              ])
            ])
          ]),
          e.subtitle ? (o(), n("span", mr, C(e.subtitle), 1)) : b("", !0)
        ]),
        s.value ? (o(), n("div", Cr, [
          l("div", xr, [
            M(x.$slots, "details", {}, () => [
              (o(!0), n(A, null, E(e.details, (p, y) => (o(), n("div", {
                ...
                l("span", vr, C(p.label), 1),
                l("span", pr, C(p.value), 1)
              ]))), 128))
            ])
          ])
        ])) : b("", !0)
  ...
  setup(e) {
    ...
    return (c, f) => (o(), Z(G(e.wrapped ? te : "div"), {
      ...
      default: _(() => [
        e.wrapped ? b("", !0) : (o(), n("div", Lr, [
          l("span", Mr, C(e.label), 1),
          l("div", Hr, [
            l("span", {
              class: g(
                d(m)(
            ...
            }, C(e.value !== null ? s.value : "--"), 3),
            l("span", Br, C(e.unit), 1)
          ])
        ])),
        l("div", {
          ...
          l("div", {
            ...
            e.showInnerLabel ? (o(), n("div", _r, [
              l("span", Zr, C(s.value) + " " + C(e.unit), 1)
            ])) : b("", !0)
          ], 2),
      ...
      default: _(() => [
        l("div", Ir, [
          ...
          l("div", Dr, [
            ...
            e.unit ? (o(), n("span", jr, C(e.unit), 1)) : b("", !0)
          ]),
          e.subtitle ? (o(), n("div", {
            key: 0,
            class: g(
...
}, Rr = { class: "w-full flex-1 relative" }, Nr = {
  key: 2,
  ...
  setup(e) {
    const t = e, r = fe(), s = w(() => re[t.color]), a = w(() => t.items.length === 0 ? 1 : Math.max(...t.items.map((h) => h.value), 1));
    function i(h) {
          ...
          e.items.length > 0 ? (o(), n("div", {
            ...
            (o(!0), n(A, null, E(e.items, (v, p) => {
              ...
              return o(), n("div", {
                ...
                e.showValues && v.value > 0 ? (o(), n("span", Or, C(u(v.value)), 1)) : b("", !0),
                l("div", Rr, [
                  l("div", {
                    class: g(
                      d(m)(
                        "absolute bottom-0 left-0.5 right-0.5 rounded-t transition-all duration-500",
                        v.highlighted ? s.value.barSolid : v.group === ((y = e.items[e.items.length - 1]) == null ? void 0 : y.group) ? s.value.barSolidMuted : s.value.barSolidFaded
                      )
                    ),
                ...
                l("span", {
                  class: g(
                    d(m)(
                      ...
                      v.highlighted ? `${s.value.textLight} ${s.value.textDark} font-medium` : v.group === ((V = e.items[e.items.length - 1]) == null ? void 0 : V.group) ? "text-gray-500 dark:text-gray-500" : "text-gray-300 dark:text-gray-500"
                    )
                  )
                }, C(v.label), 3)
              ], 2);
            }), 128))
          ], 4)) : (o(), n("div", Nr, C(e.emptyLabel), 1))
        ])
      ]),
      _: 3
    }, 8, ["class"]));
...
const o5 = ["aria-expanded"], s5 = ["onClick"], ya = /* @__PURE__ */ L({
  ...
  setup(e, { emit: t }) {
    const r = e, s = t, a = T(!1), i = T(null), u = () => {
      ...
      x.disabled || (x.onClick && x.onClick(), s("select", x), c());
    }, h = (x) => {
      x.key === "Escape" && a.value && c();
    };
    return Y(() => document.addEventListener("keydown", h)), he(() => document.removeEventListener("keydown", h)), r5(i, c), (x, v) => (o(), n("div", {
  ...
  setup(e) {
    const t = e, { isExpanded: r, isMobileOpen: s, isHovered: a, setActiveItem: i } = U();
    let u = null;
    try {
      u = Fe();
    } catch {
    ...
    return (v, p) => {
      ...
      return e.to ? (o(), Z(y, {
        ...
        d(r) || d(s) || d(a) ? (o(), n("span", n5, [
          D(C(e.label) + " ", 1),
          e.badge ? (o(), n("span", i5, C(e.badge), 1)) : b("", !0)
        ])) : b("", !0)
      ], 2));
    };
  }
  ...
  setup(e) {
    const t = e, { isExpanded: r, isMobileOpen: s, isHovered: a } = U();
    return (i, u) => (o(), n("div", {
      class: g(d(m)("mb-6", t.class))
    }, [
      e.title && (d(r) || d(s) || d(a)) ? (o(), n("div", d5, C(e.title), 1)) : b("", !0),
      l("ul", c5, [
        M(i.$slots, "default")
      ])
    ], 2));
  ...
  setup(e) {
    const t = e, { isExpanded: r, isMobileOpen: s, isHovered: a, openSubmenu: i, toggleSubmenu: u } = U(), c = w(() => i.value === t.name), f = () => u(t.name);
    return (h, x) => (o(), n("div", {
      class: g(d(m)(t.class))
    }, [
      l("button", {
...
const W5 = /* @__PURE__ */ k(O5, [["render", N5]]), K5 = {}, U5 = {
  class: "w-5 h-5",
  viewBox: "0 0 20 20",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
...
const No = /* @__PURE__ */ k(Fo, [["render", Ro]]), Wo = {}, Ko = {
  class: "w-5 h-5",
  viewBox: "0 0 20 20",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
...
const Jo = /* @__PURE__ */ k(Wo, [["render", Uo]]), Xo = {}, Qo = {
  class: "w-5 h-5",
  viewBox: "0 0 24 24",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
...
const Os = /* @__PURE__ */ k(qs, [["render", Fs]]), Rs = {}, Ns = {
  class: "w-5 h-5",
  viewBox: "0 0 20 20",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
...
const Ks = /* @__PURE__ */ k(Rs, [["render", Ws]]), Us = {}, Js = {
  class: "w-5 h-5",
  viewBox: "0 0 24 24",
  fill: "none",
  xmlns: "http://www.w3.org/2000/svg"
...
const jl = /* @__PURE__ */ k(zl, [["render", Dl]]), je = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  setup(e) {
    const t = e, r = T(""), s = T(null), a = w(() => {
      ...
      try {
        await navigator.clipboard.writeText(x), s.value = h, setTimeout(() => {
          s.value = null;
        }, 2e3);
      } catch (v) {
    ...
    return (h, x) => (o(), n("div", Al, [
      e.searchable ? (o(), n("div", El, [
        ...
        l("span", Gl, C(i.value.length) + " icons", 1)
      ])) : b("", !0),
      l("div", {
        ...
        (o(!0), n(A, null, E(i.value, (v) => (o(), n("div", {
          key: v,
          class: g(["icon-gallery-card", { "icon-gallery-card--copied": s.value === v }]),
          onClick: (p) => c(v),
          ...
          l("span", Pl, C(v), 1),
          s.value === v ? (o(), n("span", Fl, "Copied!")) : b("", !0)
        ], 42, ql))), 128))
      ], 4),
      i.value.length === 0 ? (o(), n("div", Ol, ' No icons found for "' + C(r.value) + '" ', 1)) : b("", !0)
    ]));
  }
