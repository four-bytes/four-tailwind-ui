...
const $e = "-", d1 = (e) => {
  ...
  for (let f = u.length - 1; f >= 0; f -= 1) {
    ...
    let V = !!y, H = l(V ? v.substring(0, y) : v);
    if (!H) {
      if (!V) {
        c = x + (c.length > 0 ? " " + c : c);
        continue;
...
function y1(e, ...t) {
  ...
  function u(f) {
    ...
    return r = C1(x), l = r.cache.get, a = r.cache.set, i = c, c(f);
  }
  function c(f) {
    const x = l(f);
    if (x)
...
const q1 = ["for"], P1 = {
  ...
  setup(e, { emit: t }) {
    const r = e, l = t, a = q(), i = T(!1), u = T(""), c = /^[^\s@]+@[^\s@]+\.[^\s@]+$/, f = w(() => r.error ? r.error : i.value && u.value ? u.value : "");
    function x(v) {
      var y, V;
  ...
  emits: ["update:modelValue"],
  setup(e, { emit: t }) {
    const r = e, l = t, a = T(!1), i = T(null), u = w(() => r.modelValue), c = () => {
      a.value = !a.value;
    }, f = (v) => {
      ...
      let V;
      y === -1 ? V = [...u.value, v] : V = u.value.filter((H, B) => B !== y), l("update:modelValue", V);
    }, x = (v) => {
...
const ia = /* @__PURE__ */ L({
  ...
  setup(e) {
    ...
    return (a, i) => (o(), S(Ge, { to: "body" }, [
      s("div", {
        class: g(
          d(C)("fixed z-[99999] flex flex-col gap-2 p-4", l[e.position])
        )
      }, [
        O(r1, {
...
function D0(e = {}) {
  const { initialExpanded: t = !0, mobileBreakpoint: r = 1024 } = e, l = T(t), a = T(!1), i = T(!1), u = T(!1), c = T(null), f = T(null), x = () => {
...
function j0(e = {}) {
  ...
  Y(() => {
    ...
    let p;
    b === "light" || b === "dark" ? p = b : l && ((v = window.matchMedia) != null && v.call(window, "(prefers-color-scheme: dark)").matches) ? p = "dark" : p = r, a.value = p, Q(p), i.value = !0, l && window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change", (y) => {
...
const E0 = /* @__PURE__ */ L({
  ...
  __name: "Header",
  setup(e) {
    const { toggleSidebar: t, isMobileOpen: r } = J(), l = T(!1), a = () => {
      t();
    }, i = () => {
      l.value = !l.value;
    };
      ...
      s("div", W0, [
        s("div", N0, [
          ...
          s("button", {
            type: "button",
            onClick: i,
            "aria-label": l.value ? "Close menu" : "Open menu",
  ...
  setup(e) {
    ...
    return (u, c) => (o(), n("div", {
      class: g(
        d(C)("relative rounded-full flex-shrink-0", l[e.size], t.class)
      )
    }, [
      e.src ? (o(), n("img", {
        key: 0,
...
const ir = { class: "p-4 flex flex-col items-center" }, dr = { class: "text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2" }, cr = { class: "relative w-40 h-24" }, ur = {
          ...
          s("div", xr, [
            M(b.$slots, "details", {}, () => [
              (o(!0), n(A, null, E(e.details, (v, y) => (o(), n("div", {
                ...
                s("span", vr, m(v.label), 1),
                s("span", pr, m(v.value), 1)
              ]))), 128))
            ])
          ])
        ])) : h("", !0)
      ...
      default: Z(() => [
        e.wrapped ? h("", !0) : (o(), n("div", Lr, [
          ...
          s("div", Hr, [
            ...
            }, m(e.value !== null ? l.value : "--"), 3),
            s("span", Br, m(e.unit), 1)
          ])
        ])),
        s("div", {
          ...
          s("div", {
            ...
            e.showInnerLabel ? (o(), n("div", _r, [
              s("span", Zr, m(l.value) + " " + m(e.unit), 1)
            ])) : h("", !0)
          ], 2),
  ...
  setup(e) {
    const t = e, r = fe(), l = w(() => re[t.color]), a = w(() => t.items.length === 0 ? 1 : Math.max(...t.items.map((b) => b.value), 1));
    function i(b) {
    ...
    function f(b) {
      return `color-mix(in srgb, var(--color-${t.color}-500) ${b}%, transparent)`;
    }
    const x = w(() => {
            ...
            (o(!0), n(A, null, E(e.items, (v, y) => {
              ...
              return o(), n("div", {
                ...
                s("span", {
                  ...
                  style: U({
                    color: v.highlighted ? `var(--color-${t.color}-500)` : void 0,
      ...
      s("nav", Yr, [
        s("ol", e5, [
          (o(!0), n(A, null, E(e.items, (a, i) => (o(), n("li", {
            ...
            i < e.items.length - 1 ? (o(), n("svg", t5, [...l[0] || (l[0] = [
              s("path", {
...
const o5 = ["aria-expanded"], s5 = ["onClick"], ya = /* @__PURE__ */ L({
  ...
  emits: ["select"],
  setup(e, { emit: t }) {
    const r = e, l = t, a = T(!1), i = T(null), u = () => {
      a.value = !a.value;
    }, c = () => {
      a.value = !1;
    }, f = (b) => {
      b.disabled || (b.onClick && b.onClick(), l("select", b), c());
    }, x = (b) => {
  ...
  setup(e) {
    const t = e, { isExpanded: r, isMobileOpen: l, isHovered: a, setActiveItem: i } = J();
    let u = null;
    try {
      u = Fe();
    } catch {
  ...
  setup(e) {
    const t = e, { isExpanded: r, isMobileOpen: l, isHovered: a } = J();
    return (i, u) => (o(), n("div", {
      class: g(d(C)("mb-6", t.class))
    }, [
      e.title && (d(r) || d(l) || d(a)) ? (o(), n("div", d5, m(e.title), 1)) : h("", !0),
      s("ul", c5, [
        M(i.$slots, "default")
      ])
    ], 2));
  ...
  setup(e) {
    const t = e, { isExpanded: r, isMobileOpen: l, isHovered: a, openSubmenu: i, toggleSubmenu: u } = J(), c = w(() => i.value === t.name), f = () => u(t.name);
    return (x, b) => (o(), n("div", {
      class: g(d(C)(t.class))
    }, [
      s("button", {
      ...
      c.value && (d(r) || d(l) || d(a)) ? (o(), n("div", g5, [
        M(x.$slots, "default")
      ])) : h("", !0)
    ], 2));
  }
...
const jl = /* @__PURE__ */ k(zl, [["render", Dl]]), je = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  setup(e) {
    const t = e, r = T(""), l = T(null), a = w(() => {
      ...
      try {
        await navigator.clipboard.writeText(b), l.value = x, setTimeout(() => {
          l.value = null;
        }, 2e3);
      } catch (p) {
    ...
    return (x, b) => (o(), n("div", Al, [
      e.searchable ? (o(), n("div", El, [
        ...
        s("span", Gl, m(i.value.length) + " icons", 1)
      ])) : h("", !0),
      s("div", {
        ...
        (o(!0), n(A, null, E(i.value, (p) => (o(), n("div", {
          key: p,
          class: g(["icon-gallery-card", { "icon-gallery-card--copied": l.value === p }]),
          onClick: (v) => c(p),
          ...
          s("span", Pl, m(p), 1),
          l.value === p ? (o(), n("span", Fl, "Copied!")) : h("", !0)
        ], 42, ql))), 128))
      ], 4),
