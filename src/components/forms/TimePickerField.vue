    ...
    <div class="relative">
      ...
      <span class="absolute right-3.5 top-1/2 -translate-y-1/2 pointer-events-none text-gray-500 dark:text-gray-400">
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M18.3334 10C18.3334 14.6 14.6001 18.3333 10.0001 18.3333C5.40008 18.3333 1.66675 14.6 1.66675 10C1.66675 5.4 5.40008 1.66667 10.0001 1.66667C14.6001 1.66667 18.3334 5.4 18.3334 10Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
          <path d="M13.0917 12.65L10.5084 11.1083C10.0584 10.8417 9.69175 10.2 9.69175 9.67501V6.25833" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
      </span>
    </div>
...
const inputId = computed(() => `time-${Math.random().toString(36).substr(2, 9)}`)
</script>
